...
guard_disguise = [itm_h_cervelliere_mail_aventail,itm_g_mail_gauntlets,itm_a_light_gambeson_long_sleeves_custom,itm_b_high_boots_3,itm_s_heraldic_shield_leather,itm_w_warhammer_1,itm_w_spear_7]
		...
		[
            ...
            (try_begin),
              ...
              (else_try),
                ...
                (try_end),
              (else_try),
                (this_or_next|eq, ":attacker_troop_id", "trp_flayer_infantry"),
                (eq, ":attacker_troop_id", "trp_flayer_captain"),
                # (store_random_in_range, ":random", 0, 30),
                (try_begin),
                  (lt, ":random", 2),
              ...
              (else_try), #SB : steppe bandits, pushed above generics
                (is_between, ":attacker_troop_id", "trp_routier_knight", "trp_manhunter"),
