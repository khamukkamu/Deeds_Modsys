...
common_battle_player_order = (
  ti_after_mission_start, 0.5, ti_once, [], [
    (get_player_agent_no, ":player_agent"),
    (agent_get_team, ":player_team", ":player_agent"),
	(try_begin),
	  (ge, "$player_battle_order", 0), # One order for all
      (team_give_order, ":player_team", grc_everyone, "$player_battle_order"),
	(else_try),
      (party_get_skill_level, ":tactics", "p_main_party", "skl_tactics"),
	  (store_mul, ":slot", "$player_battle_plan", grc_everyone),
	  (troop_get_slot, ":order", "trp_battle_orders", ":slot"),
      (team_give_order, ":player_team", grc_infantry, ":order"),
	  (val_add, ":slot", 1),
	  (troop_get_slot, ":order", "trp_battle_orders", ":slot"),
      (team_give_order, ":player_team", grc_archers, ":order"),
	  (val_add, ":slot", 1),
	  (troop_get_slot, ":order", "trp_battle_orders", ":slot"),
      (team_give_order, ":player_team", grc_cavalry, ":order"),
	  (gt, ":tactics", 3),
	  (call_script, "script_count_troop_classes_to_temp_troop", "p_main_party"),
	  (try_for_range, ":class", 3, grc_everyone),
	    (gt, ":tactics", ":class"),
	    (val_add, ":slot", 1),
	    (try_begin),
	      (troop_slot_ge, "trp_temp_troop", ":class", 1),
	      (troop_get_slot, ":order", "trp_battle_orders", ":slot"),
	      (team_give_order, ":player_team", ":class", ":order"),
	    (try_end),
	  (try_end),
	(try_end),
    ])
...
#-----------------------------------------------------------------
  ...
  (
    ...
    [(0,mtef_scene_source|mtef_team_0,0,0,1,[]),
     ...
     (32,mtef_visitor_source,af_town_walker,0,1,[]),(33,mtef_visitor_source,af_town_walker,0,1,[]),(34,mtef_visitor_source,af_town_walker,0,1,[]),(35,mtef_visitor_source,af_town_walker,0,1,[]),(36,mtef_visitor_source,af_town_walker,0,1,[]),(37,mtef_visitor_source,af_town_walker,0,1,[]),(38,mtef_visitor_source,af_town_walker,0,1,[]),(39,mtef_visitor_source,af_town_walker,0,1,[]),
    ...
    [
      ...
      (0, 0, ti_once, 
       ...
       [
         ...
         (try_begin),
		   (store_sub, ":troop_of_merchant", ":starting_town_faction", "fac_kingdom_1"),
