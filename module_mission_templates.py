...
pilgrim_disguise = [itm_pilgrim_hood,itm_pilgrim_disguise,itm_practice_staff, itm_throwing_daggers, itm_b_turnshoes_1]
farmer_disguise = [itm_h_felt_hat_b_brown, itm_a_farmer_tunic, itm_b_turnshoes_1, itm_w_fork_2, itm_w_onehanded_war_axe_01]
hunter_disguise = [itm_h_hood_black,itm_g_leather_gauntlet, itm_a_hunter_coat_custom, itm_w_archer_hatchet, itm_w_hunting_bow_elm, itm_w_arrow_broadhead, itm_b_turnshoes_1]
merchant_disguise = [itm_a_merchant_outfit,itm_b_turnshoes_1,itm_h_highlander_beret_red_2,itm_w_dagger_italian]
guard_disguise = [itm_h_cervelliere_mail_aventail,itm_g_gauntlets_mailed,itm_a_light_gambeson_long_sleeves_custom,itm_b_high_boots_3,itm_s_heraldic_shield_leather,itm_w_warhammer_1,itm_w_spear_7]
bard_disguise = [itm_h_highlander_beret_green_2,itm_a_noble_shirt_green,itm_b_turnshoes_1,itm_w_mace_winged,itm_lyre]
...
tournament_triggers_diplo = [
  (ti_before_mission_start, 0, 0, [], [(call_script, "script_change_banners_and_chest_tournament"), ### DAC SEEK: modified
...
###############################	
  ...
  (1, 4, ti_once, [(eq, "$g_mt_mode", abm_training),
   ...
   [
       ...
       (modify_visitors_at_site, ":arena_scene"),
       (reset_visitors),
       (party_get_slot, ":spawned_troop", "$current_town", slot_town_arena_master), # DAC Seek
       (set_visitor, 52, ":spawned_troop"),
       (set_visitor, 35, "trp_hired_blade"),
       (set_visitor, 36, "trp_hired_blade"),
       (set_jump_entry, 50),
       (jump_to_scene, ":arena_scene"),
   ...
   [
    ...
    [
     ...
     (agent_get_kill_count, ":player_kills", ":player_agent", 1),
       (store_sub, ":player_passivity", "$g_arena_training_num_agents_spawned", ":player_kills"),
  ...
  "Conversation_encounter",
   ...
   (31,mtef_visitor_source,af_override_all,0,1,[]),#(32,mtef_attackers|mtef_team_1,0,aif_start_alarmed,1,[]),
    ...
    (ti_on_agent_spawn, 0, 0, [], [
      (store_trigger_param_1, ":agent"),
      (agent_is_human, ":agent"),
      (store_random_in_range,reg0,0,100),(agent_set_animation_progress, ":agent", reg0), # break sincrony of people on background (TLD)
    ]),
  ]),
  ...
  (
   ...
   [
     ...
     (try_begin),
       ...
       (this_or_next|eq, ":dead_agent_troop_no", "trp_burgundian_prison_guard"),
...
# DAC Seek: Staged Siege
  (
    "castle_attack_walls_ladder_staged_two",mtf_battle_mode|mtf_synch_inventory,-1,
    "You attack the walls of the castle...",
    [
     (0,mtef_attackers|mtef_team_1,af_override_horse,aif_start_alarmed,12,[]),
     (0,mtef_attackers|mtef_team_1,af_override_horse,aif_start_alarmed,0,[]),
...
#32
      (32,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_a_peasant_cotehardie_custom,itm_heavy_practice_sword]),
      (33,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_a_peasant_cotehardie_custom,itm_practice_staff]),
      (34,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_a_peasant_cotehardie_custom,itm_practice_sword, itm_practice_shield]),
      (35,mtef_visitor_source|mtef_team_4,af_override_all,aif_start_alarmed,1,[itm_a_peasant_cotehardie_custom,itm_practice_staff]),
      (36,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_a_peasant_cotehardie_custom,itm_practice_bow,itm_practice_arrows_10_amount, itm_practice_dagger]), #SB : change this to lower ammo amount
      (37,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_a_peasant_cotehardie_custom,itm_practice_sword, itm_practice_shield]),
      (38,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_a_peasant_cotehardie_custom,itm_heavy_practice_sword]),
      (39,mtef_visitor_source|mtef_team_4,af_override_all,aif_start_alarmed,1,[itm_a_peasant_cotehardie_custom,itm_practice_staff]),
#40-49 not used yet
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_horse,itm_arena_tunic_yellow, itm_gold_tourney_helmet]),
...
##  ),
  ...
  (
    ...
    "Wedding",
    [
        (0,mtef_visitor_source,af_override_everything,0,1,[itm_a_tabard, itm_b_turnshoes_1]),
        ...
        (3,mtef_visitor_source,af_override_everything,0,1,[itm_a_noble_shirt_white, itm_b_turnshoes_6]),
...
##         (try_end),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only,af_override_everything,0,1,[itm_tutorial_shield,itm_tutorial_sword,itm_tutorial_short_bow,itm_tutorial_arrows,itm_a_leather_jerkin,itm_b_turnshoes_6]), #af_override_weapons
     ],
    [
      (ti_tab_pressed, 0, 0, [],
       [(try_begin),
...
##  ),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_tutorial_shield,itm_a_leather_jerkin,itm_b_turnshoes_6]),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_a_leather_jerkin,itm_b_turnshoes_6]),
        (3,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_tutorial_staff,itm_a_leather_jerkin,itm_b_turnshoes_6]),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_tutorial_sword,itm_tutorial_short_bow,itm_tutorial_arrows,itm_a_leather_jerkin,itm_b_turnshoes_6]), #af_override_weapons
     ],
    [
      (ti_tab_pressed, 0, 0, [],
       [(try_begin),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_visitor_source|mtef_team_0,af_override_everything,0,1,[itm_tutorial_sword,itm_tutorial_shield,itm_tutorial_short_bow,itm_tutorial_arrows,itm_tutorial_saddle_horse,itm_a_leather_jerkin,itm_b_turnshoes_6]),
        (1,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
        (2,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
        (3,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
        (4,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    ...
    [
      ...
      (0, 0, 0, [(try_begin),
                 ...
                 (else_try),
                   ...
                   (reset_visitors),
                   (set_visitor,5,"trp_english_archer"),
                   (set_visitor,6,"trp_english_archer"),
                   (set_visitor,7,"trp_english_archer"),
...
### DAC Seek: Dynamic camp levels		  
  ...
  (
    ...
    [
        ...
        (try_begin),
            (ge, "$skybox_test", 1),
            (val_sub, "$skybox_test", 1),
        (else_try),
            (assign, "$skybox_test", 27),
        (try_end),
        
        (assign, reg0, "$skybox_test"),
        (display_message, "@Testing skybox {reg0}"),
    ]),
    ...
    [
        ...
        (try_begin),
            (le, "$skybox_test", 27),
            (val_add, "$skybox_test", 1),
        (else_try),
            (assign, "$skybox_test", 1),
        (try_end),
...
### DAC Seek: Dynamic camp levels		  
    (ti_before_mission_start, 0, 0, [],
    [	
        (assign, ":hdr", "$skybox_test"),
        (val_add, ":hdr", 27),
        (set_skybox, "$skybox_test", ":hdr"),
    ]),		  
