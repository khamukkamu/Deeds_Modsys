...
from dac_character_creation import character_creation_simple_triggers
...
### DAC Seek: Character classes consumption bonuses/maluses
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (call_script, "script_change_player_party_morale", ":number_of_foods_player_has"),
        (display_message, "str_dac_peasant_feast", color_good_news),
      (try_end),
### DAC Seek
        (try_begin),
      ...
      (try_begin),
        ...
        (else_try), #Otherwise, act freely
          ...
          (try_begin),
            ...
            (lt, ":distance", 3),
            (party_set_ai_behavior, ":party_no", ai_bhvr_patrol_party),
           (party_template_get_slot, ":spawnpoint_begin", ":party_template", slot_party_template_lair_spawnpoint_begin),
           (party_template_get_slot, ":spawnpoint_end", ":party_template", slot_party_template_lair_spawnpoint_end),
  ...
  (1,
   [
     ...
     (try_begin),
       ...
       (display_message, "@{s1} is scouted.", color_good_news), ### DAC Seek, color coded the message
     (try_end),
     (try_begin),
       ...
       (display_message, "@{s1} is scouted.", color_good_news),
     (try_end),
     (try_begin),
...
simple_triggers += mercenary_company_simple_triggers + character_creation_simple_triggers