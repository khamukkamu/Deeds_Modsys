...
ground_specs = [
    # ("gray_stone",gtf_has_color,"stone_a",4.0,"none",(0.0,0.0,0.0)),
    # ("brown_stone",gtf_has_color,"patch_rock",2,"none",(0.0,0.0,0.0)),
    # ("turf",gtf_overlay|gtf_has_color,"grassy_ground",3.3,"ground_earth_under_grass",(0.0,0.0,0.0)),
    # ("steppe",gtf_overlay|gtf_dusty|gtf_has_color,"ground_steppe",3.0,"ground_earth_under_steppe",(0.0,0.0,0.0)),
    # ("snow",gtf_overlay|gtf_has_color,"snow",5.2,"none",(0.0,0.0,0.0)),
    # ("earth",gtf_overlay|gtf_dusty|gtf_has_color,"ground_earth",4.5,"none",(0.0,0.0,0.0)),
    # ("desert",gtf_overlay|gtf_dusty|gtf_has_color,"ground_desert", 2.5,"none",(0.0,0.0,0.0)),
    # ("forest",gtf_overlay|gtf_has_color,"ground_forest",4.2,"ground_forest_under_grass",(0.0,0.0,0.0)),
    # ("pebbles",gtf_overlay|gtf_has_color,"pebbles",4.1,"none",(0.0,0.0,0.0)),
    # ("village",gtf_overlay|gtf_has_color,"ground_village",7.0,"none",(0.0,0.0,0.0)),
    # ("path",gtf_overlay|gtf_dusty|gtf_has_color,"ground_path",6.0,"none",(0.0,0.0,0.0)),
