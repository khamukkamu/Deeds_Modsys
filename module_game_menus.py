...
( "camp_test_scene",0,
    "Test scene for the skyboxes or convenience",
    "none",
    [],
    [
    ...
    ("routier_test",[],"Test Routier Bandit Scene", [(set_jump_entry, 1),(set_jump_mission, "mt_camp_test"),(jump_to_scene, "scn_bandit_camp_routier"),(change_screen_mission),]),
    ("flayer_test",[],"Test Flayer Bandit Scene", [(set_jump_entry, 1),(set_jump_mission, "mt_camp_test"),(jump_to_scene, "scn_bandit_camp_flayer"),(change_screen_mission),]),
...
# Toggle
      ...
      ("class_enable_feature",[
        ...
        (else_try),
            (eq, "$background_type", cb_hunter),
            (str_store_string, s3, "str_dac_hunter_toggle_on"),
        (try_end),
...
### DAC Seek: New Books
      ("action_read_book_8",[(player_has_item, "itm_book_recipe_candied_fruit"),
                             (item_slot_eq, "itm_book_recipe_candied_fruit", slot_item_book_read, 0),
                             (str_store_item_name, s1, "itm_book_recipe_candied_fruit"),
                             ],"{s1}.",
       [(assign, "$temp", "itm_book_recipe_candied_fruit"),
        (jump_to_menu, "mnu_camp_action_read_book_start"),
        ]
       ),
      ("action_read_book_9",[(player_has_item, "itm_book_recipe_honeyed_dates"),
                             (item_slot_eq, "itm_book_recipe_honeyed_dates", slot_item_book_read, 0),
                             (str_store_item_name, s1, "itm_book_recipe_honeyed_dates"),
                             ],"{s1}.",
       [(assign, "$temp", "itm_book_recipe_honeyed_dates"),
        (jump_to_menu, "mnu_camp_action_read_book_start"),
        ]
       ),
      ("action_read_book_10",[(player_has_item, "itm_book_recipe_fish_verjus"),
                             (item_slot_eq, "itm_book_recipe_fish_verjus", slot_item_book_read, 0),
                             (str_store_item_name, s1, "itm_book_recipe_fish_verjus"),
                             ],"{s1}.",
       [(assign, "$temp", "itm_book_recipe_fish_verjus"),
        (jump_to_menu, "mnu_camp_action_read_book_start"),
        ]
       ),
      ("action_read_book_11",[(player_has_item, "itm_book_recipe_chicken_stew"),
                             (item_slot_eq, "itm_book_recipe_chicken_stew", slot_item_book_read, 0),
                             (str_store_item_name, s1, "itm_book_recipe_chicken_stew"),
                             ],"{s1}.",
       [(assign, "$temp", "itm_book_recipe_chicken_stew"),
        (jump_to_menu, "mnu_camp_action_read_book_start"),
        ]
       ),      
      ("action_read_book_12",[(player_has_item, "itm_book_recipe_cormarye"),
                             (item_slot_eq, "itm_book_recipe_cormarye", slot_item_book_read, 0),
                             (str_store_item_name, s1, "itm_book_recipe_cormarye"),
                             ],"{s1}.",
       [(assign, "$temp", "itm_book_recipe_cormarye"),
        (jump_to_menu, "mnu_camp_action_read_book_start"),
        ]
       ), 
      ("action_read_book_13",[(player_has_item, "itm_book_recipe_brodettum"),
                             (item_slot_eq, "itm_book_recipe_brodettum", slot_item_book_read, 0),
                             (str_store_item_name, s1, "itm_book_recipe_brodettum"),
                             ],"{s1}.",
       [(assign, "$temp", "itm_book_recipe_brodettum"),
        (jump_to_menu, "mnu_camp_action_read_book_start"),
        ]
       ), 
      ("action_read_book_14",[(player_has_item, "itm_book_recipe_beef_stywyd"),
                             (item_slot_eq, "itm_book_recipe_beef_stywyd", slot_item_book_read, 0),
                             (str_store_item_name, s1, "itm_book_recipe_beef_stywyd"),
                             ],"{s1}.",
       [(assign, "$temp", "itm_book_recipe_beef_stywyd"),
        (jump_to_menu, "mnu_camp_action_read_book_start"),
        ]
       ), 
      ("camp_action_4",[],"Back to camp menu.",
     ...
     ("continue",[],"Continue...",
      [
        ...
        (try_begin),
          ...
          (store_random_in_range, ":weapon", "itm_w_onehanded_falchion_italian", "itm_w_bastard_sword_a"),
        (else_try),
          (eq, ":faction", "fac_kingdom_3"),
          (assign, ":weapon", "itm_w_bastard_sword_c"),
        (else_try),
...
#          (try_end),
        ...
        (else_try),
          (eq, "$g_encountered_party_template", "pt_routier_bandits"),
          (set_background_mesh, "mesh_pic_swad"),
        (else_try),
          (eq, "$g_encountered_party_template", "pt_flayer_bandits"),
          (set_background_mesh, "mesh_pic_sally_out"),
        (else_try),
          (eq, "$g_encountered_party_template", "pt_retondeur_bandits"),
          (set_background_mesh, "mesh_pic_prisoner_wilderness"),
        (else_try),
          (eq, "$g_encountered_party_template", "pt_tard_venu_bandits"),
          (set_background_mesh, "mesh_pic_deserters"),
        (else_try),
          (eq, "$g_encountered_party_template", "pt_peasant_bandits"),
    ...
    [
      ...
      [
        ...
        (try_begin),
          (store_skill_level, ":tactics", skl_tactics, "trp_player"),
          (gt, ":tactics", 1),
          (assign, "$player_deploy_troops", 1),
          (str_store_string, s50, "@Start battle holding position."),
        (else_try),
          (str_store_string, s50, "@Charge the enemy."),
        (try_end),
      ],
      "{s50}",
      [
        ...
        (else_try),
            ...
            (jump_to_scene, "scn_french_village_1"),
        # End
        (else_try),
          (set_jump_mission,"mt_lead_charge"),
          (call_script, "script_setup_random_scene"),
    ...
    [
	 ...
	 (try_begin),
       ...
       (try_begin),
         ...
         (eq, ":stack_troop", "trp_tard_venu_militia"),
      ...
      ("castle_lead_attack",
       ...
       [
           ...
           # DAC Seek: Special scene for Mont St Michel
            (try_begin),
                (eq, "$g_encountered_party", "p_french_castle_17"),
      ...
      ("take_supplies",[],"Take the supplies.",
       [
         ...
         (try_begin),
            (gt,  ":village_lord", 1),
            (try_begin),
                (eq, "$class_type", cc_hunter_manhunter), ### DAC Seek, manhunter reputational damage
       ...
       [
         ...
         (else_try),
           ...
           (else_try), #SB : wtf is this
             (assign,reg0,"trp_english_footman"),
             (assign,reg1,"trp_english_footman"),
             (assign,reg2,"trp_english_archer"),
             (assign,reg3,"trp_english_militia"),
           (try_end),
           (shuffle_range,0,4),
...
#           (scene_slot_eq,  ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
       ...
       [
           ...
           (else_try),
             ...
             (reset_visitors),
             (party_get_slot, ":spawned_troop", "$current_town", slot_town_arena_master),
             (set_visitor, 52, ":spawned_troop"),
...
### DAC Seek End
      ...
      ("dplmc_guild_master_meeting",
       [(party_slot_eq,"$current_town",slot_party_type, spt_town),
		...
		(else_try),
			...
			(this_or_next|eq, "$current_town", "p_french_town_6"),
	...
	[
		...
		(neq, "$current_town", "p_french_town_6"),
  ...
  (
    ...
    [(store_faction_of_party, ":cur_faction", "$current_town"),
      ...
      (else_try),
        ...
        (try_begin),
          (eq, reg5, 1),
          (str_store_string, s18, "@One militia volunteers to follow you."),
        (else_try),
          (str_store_string, s18, "@{reg5} militias volunteer to follow you."),
        (try_end),
...
(
    ...
    [(store_faction_of_party, ":cur_faction", "$current_town"),
      ...
      (else_try),
        ...
        (try_begin),
          (eq, reg5, 1),
          (str_store_string, s18, "@One local noble will follow you."),
        (else_try),
          (str_store_string, s18, "@{reg5} local nobles will follow you."),
        (try_end),
...
####################################################################################################################
    ...
    [
      ...
      (else_try),
        ...
        #SB : set pictures
        (try_begin),
          (eq, ":bandit_template", "pt_routier_bandits"),
          (set_background_mesh, "mesh_pic_swad"),
          # (str_store_string, s5, "str_bandit_approach_defile"),
        (else_try),
          (eq, ":bandit_template", "pt_flayer_bandits"),
          # (str_store_string, s5, "str_bandit_approach_cliffs"),
          (set_background_mesh, "mesh_pic_sally_out"),
        (else_try),
          (eq, ":bandit_template", "pt_retondeur_bandits"),
          # (str_store_string, s5, "str_bandit_approach_swamp"),
          (set_background_mesh, "mesh_pic_prisoner_wilderness"),
        (else_try),
          (eq, ":bandit_template", "pt_tard_venu_bandits"),
          # (str_store_string, s5, "str_bandit_approach_swamp"),
          (set_background_mesh, "mesh_pic_deserters"),
        (else_try),
          (eq, ":bandit_template", "pt_peasant_bandits"),
    ...
    [
      ...
      [
        ...
        (set_battle_advantage, 0),
        (assign, "$g_battle_result", 0),
        (set_jump_mission,"mt_dac_bandit_lair"),
        # (set_jump_mission,"mt_castle_attack_walls_ladder"),
  ...
  ("start_phase_4",mnf_disable_all_keys,
    ...
    [
      ...
      [
        ...
        (try_begin),
          (eq, "$current_town", "p_french_town_1"),
          (assign, ":town_merchant", "trp_nord_merchant"),
          (assign, ":town_room_scene", "scn_french_town_1_room"),
        # (else_try),
          # (eq, "$current_town", "p_french_town_5"),
          # (assign, ":town_merchant", "trp_rhodok_merchant"),
          # (assign, ":town_room_scene", "scn_town_5_room"),
        (else_try),
          (eq, "$current_town", "p_french_town_6"),
          (assign, ":town_merchant", "trp_swadian_merchant"),
          (assign, ":town_room_scene", "scn_french_town_6_room"),
        (else_try),
          (eq, "$current_town", "p_french_town_8"),
          (assign, ":town_merchant", "trp_vaegir_merchant"),
          (assign, ":town_room_scene", "scn_french_town_8_room"),
        (else_try),
          (eq, "$current_town", "p_french_town_10"),
          (assign, ":town_merchant", "trp_khergit_merchant"),
          (assign, ":town_room_scene", "scn_french_town_10_room"),
        # (else_try),
          # (eq, "$current_town", "p_french_town_19"),
...
#SB : secondary cheat menu
 ...
 AI Behaviour is {s13}{reg18? (currently {s14}):}, Object is {s15}{reg19? (currently {s16}):} at ({reg20},{reg21})",
    ...
    (else_try),
      (this_or_next|eq, "$g_encountered_party_template", "pt_deserters"),
      (this_or_next|eq, "$g_encountered_party_template", "pt_routier_bandits"),	  
      (eq, "$g_encountered_party_template", "pt_routed_warriors"),
      (set_background_mesh, "mesh_pic_deserters"),
    #SB : dplmc party templates
    (else_try),
  ...
  # ("toll_crossing", 0,
    ...
    # ],"Pay the toll. ({reg1} Dragons)",[
        ...
        # (party_set_slot, "p_english_castle_2", slot_party_last_toll_paid_hours, ":toll_finish_time"),
        # (change_screen_return),
    # ]), 
