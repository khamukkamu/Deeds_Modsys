...
####################################################################################################################  
  ...
  ("cheat_find_item",0,
   ...
   ("camp_cheat_battle_scene",0,
   "Which scene do you want to visit?",
   "none",
   [],
    [
      ("qb_battle_1",[], "Farmhouse.",
      ...
      ("qb_battle_2",[], "Oasis.",
       [(set_jump_mission,"mt_town_default"),
		...
		(change_screen_mission)]),
      ("qb_battle_3",[], "Tulbuk's Pass.",
       [(set_jump_mission,"mt_town_default"),
		(jump_to_scene,"scn_quick_battle_scene_3"),
		(change_screen_mission)]),
      ("qb_battle_4",[], "Granary Hills.",
       [(set_jump_mission,"mt_town_default"),
		(jump_to_scene,"scn_quick_battle_scene_4"),
		(change_screen_mission)]),
      ("qb_battle_5",[], "Frostbite Peak.",
       [(set_jump_mission,"mt_town_default"),
		(jump_to_scene,"scn_quick_battle_scene_5"),
		(change_screen_mission)]),
      ("qb_battle_6",[], "Elysium Fields.",
       [(set_jump_mission,"mt_town_default"),
		(jump_to_scene,"scn_quick_battle_scene_6"),
		(change_screen_mission)]),

      ("qb_siege_1",[], "Haima Castle.",
       [(set_jump_mission,"mt_town_default"),
		(jump_to_scene,"scn_quick_siege_scene_1"),
		(change_screen_mission)]),
      ("qb_siege_2",[], "Ulbas Castle.",
       [(set_jump_mission,"mt_town_default"),
		(jump_to_scene,"scn_quick_siege_scene_2"),
		(change_screen_mission)]),
      ("qb_siege_3",[], "Kerrak Castle (Belfry).",
       [(set_jump_mission,"mt_town_default"),
		(jump_to_scene,"scn_quick_siege_scene_3"),
		(change_screen_mission)]),
      ("qb_siege_3b",[], "Kerrak Castle (Ladders).",
       [(set_jump_mission,"mt_town_default"),
		(jump_to_scene,"scn_quick_siege_scene_3b"),
		(change_screen_mission)]),
      ("qb_siege_4",[], "Falcis Castle.",
       [(set_jump_mission,"mt_town_default"),
		(jump_to_scene,"scn_quick_siege_scene_4"),
		(change_screen_mission)]),
      ("qb_siege_5",[], "Malsby Castle.",
       [(set_jump_mission,"mt_town_default"),
		(jump_to_scene,"scn_quick_siege_scene_5"),
		(change_screen_mission)]),
		
      ("go_back",[],"Back to camp menu.",
       [(jump_to_menu, "mnu_camp")]),
      ]
  ),
  ...
  ("camp_action",0,
   ...
   [
    ...
    [
      ...
      ("camp_battle_plan",[ (party_get_skill_level, ":tactics", "p_main_party", skl_tactics),
							(ge, ":tactics", 3),],"Prepare battle plans.",
       [(assign, "$temp", 0), (jump_to_menu, "mnu_camp_action_battle_plan"),
        ]
       ),
 ...
 Try as you might, it soon gives you a headache, and you're forced to give up the attempt."),
  ...
  ("camp_action_supply",0,
   "{s2}{s3}. Do you want to order your supplies from somewhere else?",
   "none",
   [
     (try_begin),
	   (is_between, "$player_supply_base", towns_begin, towns_end),
	   (str_store_party_name, s1, "$player_supply_base"),
	   (str_store_string, s2, "@You are resupplying your company from the town of {s1}"),
     (else_try),
	   (is_between, "$player_supply_base", villages_begin, villages_end),
	   (str_store_party_name, s1, "$player_supply_base"),
	   (str_store_string, s2, "@You are resupplying your company from the village of {s1}"),
     (else_try),
	   (str_store_string, s2, "@Your troops are carrying all their supplies with them"),
     (try_end),
     (try_begin),
	   (call_script, "script_cf_main_party_in_supply"),
       (call_script, "script_get_logistics_penalty", "$player_supply_base"),
	   (str_store_string, s3, "@, for which you are paying {reg0}% above market price due to distance"),
     (else_try),
	   (neg|is_between, "$player_supply_base", centers_begin, centers_end),
	   (str_clear, s3),
     (else_try),
	   (party_slot_eq, "$player_supply_base", slot_village_state, svs_normal),
	   (str_store_string, s3, "@, but they can not reach you because you are currently behind enemy lines"),
     (else_try),
	   (is_between, "$player_supply_base", towns_begin, towns_end),
	   (str_store_string, s3, "@, but they can not send any because the town is under siege"),
     (else_try),
	   (is_between, "$player_supply_base", villages_begin, villages_end),
	   (str_store_string, s3, "@, but they can not send any because the village was raided"),
     (try_end),
	 
   ],
    [
      ("action_supply_region_1",[(store_faction_of_party, ":town_faction", "p_town_1"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_1"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_1"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_2",[(store_faction_of_party, ":town_faction", "p_town_2"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_2"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_2"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_3",[(store_faction_of_party, ":town_faction", "p_town_3"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_3"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_3"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_4",[(store_faction_of_party, ":town_faction", "p_town_4"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_4"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_4"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_5",[(store_faction_of_party, ":town_faction", "p_town_5"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_5"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_5"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_6",[(store_faction_of_party, ":town_faction", "p_town_6"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_6"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_6"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_7",[(store_faction_of_party, ":town_faction", "p_town_7"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_7"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_7"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_8",[(store_faction_of_party, ":town_faction", "p_town_8"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_8"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_8"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_9",[(store_faction_of_party, ":town_faction", "p_town_9"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_9"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_9"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_10",[(store_faction_of_party, ":town_faction", "p_town_10"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_10"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_10"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_11",[(store_faction_of_party, ":town_faction", "p_town_11"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_11"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_11"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_12",[(store_faction_of_party, ":town_faction", "p_town_12"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_12"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_12"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_13",[(store_faction_of_party, ":town_faction", "p_town_13"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_13"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_13"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_14",[(store_faction_of_party, ":town_faction", "p_town_14"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_14"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_14"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_15",[(store_faction_of_party, ":town_faction", "p_town_15"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_15"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_15"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_16",[(store_faction_of_party, ":town_faction", "p_town_16"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_16"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_16"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_17",[(store_faction_of_party, ":town_faction", "p_town_17"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_17"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_17"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_18",[(store_faction_of_party, ":town_faction", "p_town_18"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_18"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_18"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_19",[(store_faction_of_party, ":town_faction", "p_town_19"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_19"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_19"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_20",[(store_faction_of_party, ":town_faction", "p_town_20"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_20"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_20"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_21",[(store_faction_of_party, ":town_faction", "p_town_21"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_21"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_21"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_region_22",[(store_faction_of_party, ":town_faction", "p_town_22"),
                                 (eq, ":town_faction", "$players_kingdom"),
                                 (str_store_party_name, s0, "p_town_22"),
                             ],"The region of {s0}...", [(assign, "$temp", "p_town_22"),
									   (jump_to_menu, "mnu_camp_action_supply_region")]),
      ("action_supply_cancel",[(is_between, "$player_supply_base", centers_begin, centers_end),
							 ],"Cancel the supply order.", [(assign, "$player_supply_base", -1)]),
      ("camp_action_back",[],"Back to camp menu.",
       [(jump_to_menu, "mnu_camp"),
        ]
       ),
      ]
  ...
  ("camp_action_supply_region",0,
   "{s3} This may vary slightly if you choose one of the nearby villages instead.",
   "none",
   [ (str_store_party_name, s0, "$temp"),
     (call_script, "script_get_logistics_penalty", "$temp"),
	 (str_store_string, s3, "@Due to your distance from the town of {s0}, you can expect to pay {reg0}% above market price if you supply from there."),
	 (assign,reg1,0), (assign,reg2,0), (assign,reg3,0), (assign,reg4,0), (assign,reg5,0), (assign,reg6,0),
     (try_for_range, ":cur_village", villages_begin, villages_end),
	   (party_slot_eq, ":cur_village", slot_village_market_town, "$temp"),
	   (try_begin),
	     (eq, reg1, 0),
	     (assign, reg1, ":cur_village"),
	   (else_try),
	     (eq, reg2, 0),
	     (assign, reg2, ":cur_village"),
	   (else_try),
	     (eq, reg3, 0),
	     (assign, reg3, ":cur_village"),
	   (else_try),
	     (eq, reg4, 0),
	     (assign, reg4, ":cur_village"),
	   (else_try),
	     (eq, reg5, 0),
	     (assign, reg5, ":cur_village"),
	   (else_try),
	     (eq, reg6, 0),
	     (assign, reg6, ":cur_village"),
	   (try_end),
     (try_end),
   ],
    [
      ("action_supply_region_town",[ (try_begin),
									   (party_slot_eq, "$temp", slot_village_state, svs_normal),
									   (str_clear, s17),
									 (else_try),
									   (str_store_string, s17, "@ (under siege)"),
									 (try_end),
                             ],"The town of {s0}{s17}.", [(assign, "$player_supply_base", "$temp"),
														  (jump_to_menu, "mnu_camp_action_supply")]),
      ("action_supply_region_village_1",[ (gt, reg1, 0),
										  (str_store_party_name, s0, reg1),
										  (try_begin),
											(party_slot_eq, "$temp", slot_village_state, svs_normal),
											(str_clear, s17),
										  (else_try),
											(str_store_string, s17, "@ (raided)"),
										  (try_end),
                             ],"The village of {s0}{s17}.", [(assign, "$player_supply_base", reg1),
															 (jump_to_menu, "mnu_camp_action_supply")]),
      ("action_supply_region_village_2",[ (gt, reg2, 0),
										  (str_store_party_name, s0, reg2),
										  (try_begin),
											(party_slot_eq, "$temp", slot_village_state, svs_normal),
											(str_clear, s17),
										  (else_try),
											(str_store_string, s17, "@ (raided)"),
										  (try_end),
                             ],"The village of {s0}{s17}.", [(assign, "$player_supply_base", reg2),
															 (jump_to_menu, "mnu_camp_action_supply")]),
      ("action_supply_region_village_3",[ (gt, reg3, 0),
										  (str_store_party_name, s0, reg3),
										  (try_begin),
											(party_slot_eq, "$temp", slot_village_state, svs_normal),
											(str_clear, s17),
										  (else_try),
											(str_store_string, s17, "@ (raided)"),
										  (try_end),
                             ],"The village of {s0}{s17}.", [(assign, "$player_supply_base", reg3),
															 (jump_to_menu, "mnu_camp_action_supply")]),
      ("action_supply_region_village_4",[ (gt, reg4, 0),
										  ...
										  (else_try),
											(str_store_string, s17, "@ (raided)"),
										  (try_end),
                             ],"The village of {s0}{s17}.", [(assign, "$player_supply_base", reg4),
															 (jump_to_menu, "mnu_camp_action_supply")]),
      ("action_supply_region_village_5",[ (gt, reg5, 0),
										  (str_store_party_name, s0, reg5),
										  (try_begin),
											(party_slot_eq, "$temp", slot_village_state, svs_normal),
											(str_clear, s17),
										  (else_try),
											(str_store_string, s17, "@ (raided)"),
										  (try_end),
                             ],"The village of {s0}{s17}.", [(assign, "$player_supply_base", reg5),
															 (jump_to_menu, "mnu_camp_action_supply")]),
      ("action_supply_region_village_6",[ (gt, reg6, 0),
										  (str_store_party_name, s0, reg6),
										  (try_begin),
											(party_slot_eq, "$temp", slot_village_state, svs_normal),
											(str_clear, s17),
										  (else_try),
											(str_store_string, s17, "@ (raided)"),
										  (try_end),
                             ],"The village of {s0}{s17}.", [(assign, "$player_supply_base", reg6),
															 (jump_to_menu, "mnu_camp_action_supply")]),
      ("camp_action_back",[],"Back to supply menu.",
       [(assign, "$temp", 0),(jump_to_menu, "mnu_camp_action_supply")]),
      ]
  ),
  
  ("select_battle_plan",0,
   "You can select any battle plan you have prepared with your troops in camp. Which one shall it be?",
   "none",
   [],
    [
      ("select_plan_0",[(call_script, "script_store_codename_for_plan_to_s1", 0),
						  ],"Plan {s1}.",
       [(assign, "$player_battle_plan", 0), (jump_to_menu, "$g_next_menu")]),
      ("select_plan_1",[(store_mul, ":slot", 1, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", 0),
						(call_script, "script_store_codename_for_plan_to_s1", 1),
						  ],"Plan {s1}.",
       [(assign, "$player_battle_plan", 1), (jump_to_menu, "$g_next_menu")]),
      ("select_plan_2",[(store_mul, ":slot", 2, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", 0),
						(call_script, "script_store_codename_for_plan_to_s1", 2),
						  ],"Plan {s1}.",
       [(assign, "$player_battle_plan", 2), (jump_to_menu, "$g_next_menu")]),
      ("select_plan_3",[(store_mul, ":slot", 3, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", 0),
						(call_script, "script_store_codename_for_plan_to_s1", 3),
						  ],"Plan {s1}.",
       [(assign, "$player_battle_plan", 3), (jump_to_menu, "$g_next_menu")]),
      ("select_plan_4",[(store_mul, ":slot", 4, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", 0),
						(call_script, "script_store_codename_for_plan_to_s1", 4),
						  ],"Plan {s1}.",
       [(assign, "$player_battle_plan", 4), (jump_to_menu, "$g_next_menu")]),
      ("select_plan_5",[(store_mul, ":slot", 5, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", 0),
						(call_script, "script_store_codename_for_plan_to_s1", 5),
						  ],"Plan {s1}.",
       [(assign, "$player_battle_plan", 5), (jump_to_menu, "$g_next_menu")]),
      ("select_plan_6",[(store_mul, ":slot", 6, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", 0),
						(call_script, "script_store_codename_for_plan_to_s1", 6),
						  ],"Plan {s1}.",
       [(assign, "$player_battle_plan", 6), (jump_to_menu, "$g_next_menu")]),
      ("select_plan_7",[(store_mul, ":slot", 7, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", 0),
						(call_script, "script_store_codename_for_plan_to_s1", 7),
						  ],"Plan {s1}.",
       [(assign, "$player_battle_plan", 7), (jump_to_menu, "$g_next_menu")]),
      ("select_plan_8",[(store_mul, ":slot", 8, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", 0),
						(call_script, "script_store_codename_for_plan_to_s1", 8),
						  ],"Plan {s1}.",
       [(assign, "$player_battle_plan", 8), (jump_to_menu, "$g_next_menu")]),
      ("select_plan_9",[(store_mul, ":slot", 9, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", 0),
						(call_script, "script_store_codename_for_plan_to_s1", 9),
						  ],"Plan {s1}.",
       [(assign, "$player_battle_plan", 9), (jump_to_menu, "$g_next_menu")]),
  ...
  ("camp_action_battle_plan",0,
   "{s10} Tactics skill allows you have {reg11} different battle plans.^Which one do you want to change?",
   "none",
   [
     (call_script, "script_get_max_skill_of_player_party", skl_tactics),
     (store_sub, reg10, reg0, grc_everyone),
	 (try_begin),
	   (eq, reg1, "trp_player"),
	   (str_store_string, s10, "@Your"),
	 (else_try),
	   (str_store_troop_name, s1, reg1),
	   (str_store_string, s10, "@{s1}'s"),
	 (try_end),
	 (try_begin),
	   (gt, reg10, 0),
	   (store_add, reg11, reg10, 1),
	 (else_try),
	   (assign, "$temp", 0),
	   (jump_to_menu, "mnu_camp_action_edit_battle_plan"),
	 (try_end),

   ],
    [
      ("change_plan_0",[(call_script, "script_store_codename_for_plan_to_s1", 0),
						  ],"Change Plan {s1}.",
       [(assign, "$temp", 0), (jump_to_menu, "mnu_camp_action_edit_battle_plan")]),
      ("change_plan_1",[(ge, reg10, 4),
						(store_mul, ":slot", 1, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", -1),
						(try_begin),
						  (troop_slot_ge, "trp_battle_orders", ":slot", 0),
						  (str_store_string, s0, "@Change"),
						(else_try),
						  (str_store_string, s0, "@Create"),
						(try_end),
						(call_script, "script_store_codename_for_plan_to_s1", 1),
						  ],"{s0} Plan {s1}.",
       [(assign, "$temp", 1), (jump_to_menu, "mnu_camp_action_edit_battle_plan")]),
      ("change_plan_2",[(ge, reg10, 1),
						(store_mul, ":slot", 2, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", -1),
						(try_begin),
						  (troop_slot_ge, "trp_battle_orders", ":slot", 0),
						  (str_store_string, s0, "@Change"),
       ...
       [(assign, "$temp", 2), (jump_to_menu, "mnu_camp_action_edit_battle_plan")]),
      ("change_plan_3",[(ge, reg10, 2),
						(store_mul, ":slot", 3, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", -1),
						(try_begin),
						  (troop_slot_ge, "trp_battle_orders", ":slot", 0),
						  (str_store_string, s0, "@Change"),
       ...
       [(assign, "$temp", 3), (jump_to_menu, "mnu_camp_action_edit_battle_plan")]),
      ("change_plan_4",[(ge, reg10, 6),
						(store_mul, ":slot", 4, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", -1),
						(try_begin),
						  (troop_slot_ge, "trp_battle_orders", ":slot", 0),
						  (str_store_string, s0, "@Change"),
       ...
       [(assign, "$temp", 4), (jump_to_menu, "mnu_camp_action_edit_battle_plan")]),
      ("change_plan_5",[(ge, reg10, 3),
						(store_mul, ":slot", 5, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", -1),
						(try_begin),
						  (troop_slot_ge, "trp_battle_orders", ":slot", 0),
						  (str_store_string, s0, "@Change"),
       ...
       [(assign, "$temp", 5), (jump_to_menu, "mnu_camp_action_edit_battle_plan")]),
      ("change_plan_6",[(ge, reg10, 5),
						(store_mul, ":slot", 6, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", -1),
						(try_begin),
						  (troop_slot_ge, "trp_battle_orders", ":slot", 0),
						  (str_store_string, s0, "@Change"),
       ...
       [(assign, "$temp", 6), (jump_to_menu, "mnu_camp_action_edit_battle_plan")]),
      ("change_plan_7",[(ge, reg10, 7),
						(store_mul, ":slot", 7, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", -1),
						(try_begin),
						  (troop_slot_ge, "trp_battle_orders", ":slot", 0),
						  (str_store_string, s0, "@Change"),
       ...
       [(assign, "$temp", 7), (jump_to_menu, "mnu_camp_action_edit_battle_plan")]),
      ("change_plan_8",[(ge, reg10, 8),
						(store_mul, ":slot", 8, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", -1),
						(try_begin),
						  (troop_slot_ge, "trp_battle_orders", ":slot", 0),
						  (str_store_string, s0, "@Change"),
       ...
       [(assign, "$temp", 8), (jump_to_menu, "mnu_camp_action_edit_battle_plan")]),
      ("change_plan_9",[(ge, reg10, 9),
						(store_mul, ":slot", 9, grc_everyone),
						(troop_slot_ge, "trp_battle_orders", ":slot", -1),
						(try_begin),
						  (troop_slot_ge, "trp_battle_orders", ":slot", 0),
						  (str_store_string, s0, "@Change"),
       ...
       [(assign, "$temp", 9), (jump_to_menu, "mnu_camp_action_edit_battle_plan")]),
	   
      ("camp_action_back",[],"Back to camp menu.",
       [(jump_to_menu, "mnu_camp")]),
      ]
  ),
  ("camp_action_edit_battle_plan",0,
   "{s10}^^Click the orders to change them. You can rename the custom classes and assign troops to them in the party menu.^^These are the initial orders for each class{reg11? in Plan {s2}:}:",
   "none",
   [ (store_mul, reg9, "$temp", grc_everyone), # offset
     (try_begin),
	   (neg|troop_slot_ge, "trp_battle_orders", reg9, 0),
	   (troop_get_inventory_slot, ":player_horse", "trp_player", ek_horse),
	   (call_script, "script_reset_battle_order_set", ":player_horse", "$temp"),
	 (try_end),
     (call_script, "script_get_max_skill_of_player_party", skl_tactics),
     (assign, reg10, reg0),
	 (try_begin),
	 ...
	 (try_end),
	 (try_begin),
	   (lt, reg10, grc_everyone),
	   (str_store_string, s10, "@{s10} Tactics skill allows you to plan orders for the first {reg10} classes."),
	 (else_try),
	   (str_store_string, s10, "@{s10} Tactics skill allows you to plan individual orders for all classes."),
	 (try_end),
     (store_sub, reg11, reg10, grc_everyone),
	 (val_max, reg11, 0),
	 (call_script, "script_store_codename_for_plan_to_s1", "$temp"),
	 (call_script, "script_count_troop_classes_to_temp_troop", "p_main_party"),
	 (str_store_string_reg, s2, s1),
   ],
    [
      ("change_orders_class_0",[(str_store_class_name, s0, grc_infantry),
								(store_add, ":slot", reg9, grc_infantry),
								(troop_get_slot, ":order", "trp_battle_orders", ":slot"),
								(call_script, "script_store_movement_order_imperative_to_s1", ":order"),
								(troop_get_slot, reg0, "trp_temp_troop", grc_infantry),
                             ],"{s0} ({reg0}) will {s1}.", [(call_script, "script_toggle_order_for_class_in_plan", grc_infantry, "$temp")]),
      ("change_orders_class_1",[(str_store_class_name, s0, grc_archers),
								(store_add, ":slot", reg9, grc_archers),
								(troop_get_slot, ":order", "trp_battle_orders", ":slot"),
								(call_script, "script_store_movement_order_imperative_to_s1", ":order"),
								(troop_get_slot, reg0, "trp_temp_troop", grc_archers),
                             ],"{s0} ({reg0}) will {s1}.", [(call_script, "script_toggle_order_for_class_in_plan", grc_archers, "$temp")]),
      ("change_orders_class_2",[(str_store_class_name, s0, grc_cavalry),
								(store_add, ":slot", reg9, grc_cavalry),
								(troop_get_slot, ":order", "trp_battle_orders", ":slot"),
								(call_script, "script_store_movement_order_imperative_to_s1", ":order"),
								(troop_get_slot, reg0, "trp_temp_troop", grc_cavalry),
                             ],"{s0} ({reg0}) will {s1}.", [(call_script, "script_toggle_order_for_class_in_plan", grc_cavalry, "$temp")]),
		# Custom classes start here:
      ("change_orders_class_3",[(gt, reg10, 3),
								(troop_slot_ge, "trp_temp_troop", 3, 1),
								(str_store_class_name, s0, 3),
								(store_add, ":slot", reg9, 3),
								(troop_get_slot, ":order", "trp_battle_orders", ":slot"),
								(call_script, "script_store_movement_order_imperative_to_s1", ":order"),
								(troop_get_slot, reg0, "trp_temp_troop", 3),
                             ],"{s0} ({reg0}) will {s1}.", [(call_script, "script_toggle_order_for_class_in_plan", 3, "$temp")]),
      ("change_orders_class_4",[(gt, reg10, 4),
								(troop_slot_ge, "trp_temp_troop", 4, 1),
								(str_store_class_name, s0, 4),
								(store_add, ":slot", reg9, 4),
								(troop_get_slot, ":order", "trp_battle_orders", ":slot"),
								(call_script, "script_store_movement_order_imperative_to_s1", ":order"),
								(troop_get_slot, reg0, "trp_temp_troop", 4),
                             ],"{s0} ({reg0}) will {s1}.", [(call_script, "script_toggle_order_for_class_in_plan", 4, "$temp")]),
      ("change_orders_class_5",[(gt, reg10, 5),
								(troop_slot_ge, "trp_temp_troop", 5, 1),
								(str_store_class_name, s0, 5),
								(store_add, ":slot", reg9, 5),
								(troop_get_slot, ":order", "trp_battle_orders", ":slot"),
								(call_script, "script_store_movement_order_imperative_to_s1", ":order"),
								(troop_get_slot, reg0, "trp_temp_troop", 5),
                             ],"{s0} ({reg0}) will {s1}.", [(call_script, "script_toggle_order_for_class_in_plan", 5, "$temp")]),
      ("change_orders_class_6",[(gt, reg10, 6),
								(troop_slot_ge, "trp_temp_troop", 6, 1),
								(str_store_class_name, s0, 6),
								(store_add, ":slot", reg9, 6),
								(troop_get_slot, ":order", "trp_battle_orders", ":slot"),
								(call_script, "script_store_movement_order_imperative_to_s1", ":order"),
								(troop_get_slot, reg0, "trp_temp_troop", 6),
                             ],"{s0} ({reg0}) will {s1}.", [(call_script, "script_toggle_order_for_class_in_plan", 6, "$temp")]),
      ("change_orders_class_7",[(gt, reg10, 7),
								(troop_slot_ge, "trp_temp_troop", 7, 1),
								(str_store_class_name, s0, 7),
								(store_add, ":slot", reg9, 7),
								(troop_get_slot, ":order", "trp_battle_orders", ":slot"),
								(call_script, "script_store_movement_order_imperative_to_s1", ":order"),
								(troop_get_slot, reg0, "trp_temp_troop", 7),
                             ],"{s0} ({reg0}) will {s1}.", [(call_script, "script_toggle_order_for_class_in_plan", 7, "$temp")]),
      ("change_orders_class_8",[(gt, reg10, 8),
								(troop_slot_ge, "trp_temp_troop", 8, 1),
								(str_store_class_name, s0, 8),
								(store_add, ":slot", reg9, 8),
								(troop_get_slot, ":order", "trp_battle_orders", ":slot"),
								(call_script, "script_store_movement_order_imperative_to_s1", ":order"),
								(troop_get_slot, reg0, "trp_temp_troop", 8),
                             ],"{s0} ({reg0}) will {s1}.", [(call_script, "script_toggle_order_for_class_in_plan", 8, "$temp")]),
	  
      ("change_orders_default",[(eq, "$temp", 0)],"Reset these orders.", [  (troop_get_inventory_slot, ":player_horse", "trp_player", ek_horse),
															(call_script, "script_reset_battle_order_set", ":player_horse", "$temp")]),
      ("change_orders_delete",[(gt, "$temp", 0)],"Remove this plan.", [
									(store_mul, ":first_slot", "$temp", grc_everyone),
									(store_add, ":last_slot", ":first_slot", grc_everyone),
									(try_for_range, ":cur_slot", ":first_slot", ":last_slot"),
									  (troop_set_slot, "trp_battle_orders", ":cur_slot", -1),
									(try_end),
									(jump_to_menu, "mnu_camp"),
								  ]),
      ("camp_action_back",[],"Back to camp menu.",
  ...
  (
    ...
    [
      ...
      [
        ...
        (eq,"$cant_leave_encounter", 0), # Default when attacking
      ],
      "Charge the enemy!",
      [
        (assign, "$g_battle_result", 0),
        (assign, "$g_engaged_enemy", 1),
		(assign, "$player_battle_order", mordr_charge),
        (call_script, "script_setup_simple_encounter_battle"),
        (assign, "$g_next_menu", "mnu_simple_encounter"),
        (jump_to_menu, "mnu_battle_debrief"),
        (change_screen_mission),
      ]),
      ("encounter_counterattack",
      [
        (eq, "$encountered_party_friendly", 0),
        (neg|troop_is_wounded, "trp_player"),
      ...
      "Lead you men into battle.",
      [
        (assign, "$g_battle_result", 0),
        (assign, "$g_engaged_enemy", 1),
		(assign, "$player_battle_order", mordr_follow),
        (call_script, "script_setup_simple_encounter_battle"),
        (assign, "$g_next_menu", "mnu_simple_encounter"),
        (jump_to_menu, "mnu_battle_debrief"),
        (change_screen_mission),
      ...
      [
        (eq, "$encountered_party_friendly", 0),
        (neg|troop_is_wounded, "trp_player"),
        (eq,"$cant_leave_encounter", 1), # Default when attacked
      ],
      "Stand your ground.",
      [
        (assign, "$g_battle_result", 0),
        (assign, "$g_engaged_enemy", 1),
		(assign, "$player_battle_order", mordr_hold),
        (call_script, "script_setup_simple_encounter_battle"),
        (assign, "$g_next_menu", "mnu_simple_encounter"),
        (jump_to_menu, "mnu_battle_debrief"),
        (change_screen_mission),
      ...
      [
		...
		(party_get_skill_level, ":tactics", "p_main_party", skl_tactics),
		(ge, ":tactics", 2),
        (eq,"$cant_leave_encounter", 0), # Default when attacked
      ],
      ...
      ("encounter_plan",
      [ (store_mul, ":offset", "$player_battle_plan", grc_everyone),
		(troop_slot_ge, "trp_battle_orders", ":offset", 0), # Is there even a plan?
        (eq, "$encountered_party_friendly", 0),
        (neg|troop_is_wounded, "trp_player"),
		(party_get_skill_level, ":tactics", "p_main_party", skl_tactics),
		(ge, ":tactics", 3),
      ...
      [
        (assign, "$g_battle_result", 0),
        (assign, "$g_engaged_enemy", 1),
		(assign, "$player_battle_order", -1),
        (call_script, "script_setup_simple_encounter_battle"),
        (assign, "$g_next_menu", "mnu_simple_encounter"),
        (jump_to_menu, "mnu_battle_debrief"),
        (change_screen_mission),
      ]),
      ("encounter_change_plan",
      [ (party_get_skill_level, ":tactics", "p_main_party", skl_tactics),
		(ge, ":tactics", 10), # Can have multiple plans
		(store_mul, ":offset", "$player_battle_plan", grc_everyone),
		(troop_slot_ge, "trp_battle_orders", ":offset", 0), # Is there even a plan?
		(call_script, "script_store_codename_for_plan_to_s1", "$player_battle_plan"),
      ],
      "Using Plan {s1}. Change...",
      [ (assign, "$g_next_menu", "mnu_simple_encounter"),
        (jump_to_menu, "mnu_select_battle_plan"),
      ]),
      ("encounter_select_plan",
      [ (party_get_skill_level, ":tactics", "p_main_party", skl_tactics),
		(ge, ":tactics", 10), # Can have multiple plans
		(store_mul, ":offset", "$player_battle_plan", grc_everyone),
		(neg|troop_slot_ge, "trp_battle_orders", ":offset", 0), # There is no plan!
      ],
      "No battle plan. Change...",
      [ (assign, "$g_next_menu", "mnu_simple_encounter"),
        (jump_to_menu, "mnu_select_battle_plan"),
      ]),
    ...
    [
      ...
      ("village_center",[(neg|party_slot_eq, "$current_town", slot_village_state, svs_looted),
       ...
       [
         (try_begin),
           (call_script, "script_cf_enter_center_location_bandit_check"),
         (else_try),
           (party_get_slot, ":village_scene", "$current_town", slot_village_center),
      ...
      ("village_attack_bandits",[(party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),],
       ...
       [(party_get_slot, ":bandit_troop", "$current_town", slot_village_infested_by_bandits),
		...
		(faction_get_slot, ":villager_troop", ":original_faction", slot_faction_village_walker_male_troop),
		(try_begin),
			(le, ":villager_troop", 0),
			(assign, ":villager_troop", "trp_farmer"),
		(try_end),
        (modify_visitors_at_site,":scene_to_use"),
        (reset_visitors),
        (set_visitors, 0, ":bandit_troop", "$qst_eliminate_bandits_infesting_village_num_bandits"),
        (set_visitors, 2, ":villager_troop", "$qst_eliminate_bandits_infesting_village_num_villagers"),
        (set_party_battle_mode),
  ...
  (
    ...
    [    
	 ...
	 #          (val_add, ":prosperity", 5),
        ...
        (try_begin), 
		  (party_slot_eq, "$current_town", slot_party_type, spt_town),
          (gt, "$main_party_collected_loot", 0),
          (assign, reg15, "$main_party_collected_loot"),
		  (call_script, "script_get_max_skill_of_player_party", skl_trade),
		  (try_begin),
		    (neq, reg1, "trp_player"),
			(str_store_troop_name, s16, reg1),
		  (try_end),
		  (call_script, "script_get_trade_penalty", "itm_sword_viking_1", "$current_town"), # any weapon or armor will do
          (store_add, ":penalty_divisor", 100, reg0),
          (val_mul, reg15, 100),
          (val_div, reg15, ":penalty_divisor"),
          (gt, reg15, 0),
          (str_store_string, s15, "@^{reg1?{s16} has:You have} sold various loot and scrap for {reg15} denars."),
		  (troop_add_gold, "trp_player", reg15),
          (assign, "$main_party_collected_loot", 0),
        (try_end),
    ...
    [
      ("peasant_start_practice", [], "Start the practice fight.",
       [
         ...
         (party_get_slot, ":village_scene", ":target_center", slot_village_center),
         (modify_visitors_at_site, ":village_scene"),
         (reset_visitors),
         (set_visitor, 0, "trp_player"),
...
####################################################################################################################   
  ...
  ( "center_port",0,
    "You are at the port of {s2}. {s4}",
    "none",
    [(str_store_party_name, s2, "$current_town"),
	 (assign, "$temp", -1),
	 (try_for_range, ":cur_captain", tavern_captains_begin, tavern_captains_end),
	   (troop_slot_eq, ":cur_captain", slot_troop_cur_center, "$current_town"),
	   (this_or_next|lt, "$temp", 0),
	   (troop_slot_eq, ":cur_captain", slot_troop_home_port, "$current_town"),
	   (assign, "$temp", ":cur_captain"),
	 (try_end),
	 (assign, reg5, 0), # Can sail?
	 (try_begin),
	   (gt, "$players_captain", 0),
	   (str_store_troop_name, s3, "$players_captain"),
	   (troop_get_slot, ":ship_town", "$players_captain", slot_troop_cur_center),
	   (try_begin),
	     (eq, ":ship_town", "$current_town"),
	     (str_store_string, s4, "@{s3}'s crew is here, awaiting your orders."),
	     (assign, reg5, 1),
	   (else_try),
	     (gt, ":ship_town", 0),
	     (str_store_party_name, s5, ":ship_town"),
	     (str_store_string, s4, "@But {s3}'s crew is currently at {s5}."),
	   (else_try),
	     (str_store_string, s4, "@But {s3}'s crew is currently anchored somewhere else."),
	   (try_end),
	 (else_try),
	   (gt, "$players_captain", 0),
	 (else_try),
	   (le, "$temp", 0),
	   (str_store_string, s4, "@No ship can be chartered here at the moment."),
	 (else_try),
	   (store_troop_gold, reg6, "trp_player"),
	   (lt, reg6, ship_charter_cost),
	   (str_store_string, s4, "@You can not afford to charter a ship at the moment."),
	 (else_try),
	   (str_store_troop_name, s3, "$temp"),
	   (troop_get_slot, reg7, "$temp", slot_troop_player_debt),
	   (ge, reg7, 1),
	   (str_store_string, s4, "@{s3} refuses to deal with you until you have repaid your debts of {reg7} denars."),
	 (else_try),
	   (assign, reg5, 1),
	   (str_store_string, s4, "@You can charter {s3}'s ship for 100 denars per day."),
	 (try_end),
	 
	],
    [
      ("charter_ship", [(eq, reg5, 1), (le, "$players_captain", 0)],
      "Charter ship.",
      [ (call_script,"script_cf_get_center_port","$current_town"),
        (party_get_position, pos1, reg0),
        (assign, "$g_player_icon_state", pis_ship),
        ...
        (map_get_water_position_around_position, pos2, pos1, 1),
        (party_set_position, "p_main_party", pos2),
		(troop_remove_gold, "trp_player", ship_charter_cost),
		(assign, "$players_captain", "$temp"),
		(store_current_hours, ":time"),
		(troop_set_slot, "$players_captain", slot_troop_last_talk_time, ":time"),
		(troop_set_slot, "$players_captain", slot_troop_cur_center, -1),
        (change_screen_return),
      ]),
      ("pay_debt", [(ge, reg7, 1), (ge, reg6, reg7)],
      "Pay debts to {s3}.",
      [ (troop_remove_gold, "trp_player", reg7),
	    (troop_set_slot, "$temp", slot_troop_player_debt, 0),
      ]),
      ("sail_from_port", [(eq, reg5, 1), (gt,"$players_captain",0)],
      "Sail from port.",
      [ (call_script,"script_cf_get_center_port","$current_town"),
        (party_get_position, pos1, reg0),
        (assign, "$g_player_icon_state", pis_ship),
      ...
      ("dismiss_captain", [(gt,"$players_captain",0)],
      "Dismiss {s3}'s crew.", [
  ...
  ( "port_disembark",0,
    "You have reached the port of {s2}. Do you wish to disembark?",
    "none",
    [(party_get_slot, ":port_town", "$g_encountered_party", slot_port_bound_center),
	 (str_store_party_name, s2, ":port_town")],
    [
      ("disembark_wait", [], "Yes, tell the crew to wait in port.",
       [(assign, "$g_player_icon_state", pis_normal),
        (party_set_flags, "p_main_party", pf_is_ship, 0),
        (party_get_position, pos1, "$g_encountered_party"),
		(map_get_land_position_around_position, pos0, pos1, 2),
        (party_set_position, "p_main_party", pos0),
		(party_get_slot, ":port_town", "$g_encountered_party", slot_port_bound_center),
		(troop_set_slot, "$players_captain", slot_troop_cur_center, ":port_town"),
        (change_screen_return),
        ]),
	  ("disembark_send_back", [], "Yes, tell the crew to sail home.",
       [(assign, "$g_player_icon_state", pis_normal),
        (party_set_flags, "p_main_party", pf_is_ship, 0),
        (party_get_position, pos1, "$g_encountered_party"),
		(map_get_land_position_around_position, pos0, pos1, 2),
      ...
      ("disembark_no", [], "No, I want to go somewhere else.",
       [(change_screen_return),
        ]),
    ]
  ),
  ...
  ("ship_anchor",0,
   "You lower the sails and drop anchor. What do you want to do?",
   "none",
   [ (party_set_icon, "p_main_party", "icon_ship"),
    ],
    [
      ("anchor_action_1",[(eq,"$cheat_mode",1)],"{!}Cheat: Walk around.",
       [(set_jump_mission,"mt_ai_training"),
        (call_script, "script_setup_random_scene"),
        (change_screen_mission),
        ]
       ),
      ("anchor_wait_here",[],"Wait here for some time.",
       [
           (assign,"$g_camp_mode", 1),
           (assign, "$g_infinite_camping", 0),
		   (party_set_icon, "p_main_party", "icon_ship_on_land"),
      ...
      ("anchor_disembark",[
       ...
       [   (party_set_position, "p_main_party", pos2),
		   (set_fixed_point_multiplier, 100),
		   (position_get_x, ":x1", pos1), (position_get_y, ":y1", pos1),
		   (position_get_x, ":x2", pos2), (position_get_y, ":y2", pos2),
		   (val_sub, ":x2", ":x1"), (val_sub, ":y2", ":y1"),
		   (store_atan2, ":phi1", ":y2", ":x2"),
		   (position_get_rotation_around_z, ":phi0", pos2),
		   (val_sub, ":phi1", ":phi0"),
		   (position_rotate_z_floating, pos2, ":phi1"),
		   (party_set_position, "p_landed_ship", pos2),
		   (str_store_troop_name_plural, s3, "$players_captain"),
		   (party_set_name, "p_landed_ship", "@{s3}'s Ship"),
           (enable_party, "p_landed_ship"),
		   (assign, "$g_player_icon_state", pis_normal),
           (party_set_flags, "p_main_party", pf_is_ship, 0),
           (change_screen_return),
        ]
       ),
      ("anchor_set_sails",[],"Set sails.",[(change_screen_return)]),
      ]
  ),
  
  (
    "ship_reembark",0,
    "You return to {s3}'s ship. Do you wish to embark?",
    "none",
    [(str_store_troop_name, s3, "$players_captain")],
    [
      ("reembark_yes", [], "Yes.",
       [(assign, "$g_player_icon_state", pis_ship),
        (party_set_flags, "p_main_party", pf_is_ship, 1),
        (party_get_position, pos1, "p_landed_ship"),
        (map_get_water_position_around_position, pos2, pos1, 1),
        (party_set_position, "p_main_party", pos2),
        (disable_party, "p_landed_ship"),
        (change_screen_return),
        ]),
      ("reembark_no", [], "No.",
       [(change_screen_return),
...
####################################################################################################################
  ...
  ("start_phase_3",mnf_disable_all_keys,
    ...
    [
      ("continue",[], "Continue...",
       [         
         (party_get_slot, ":town_faction", "$g_starting_town", slot_center_original_faction),
         (call_script, "script_set_player_troop_types", ":town_faction"),
  ...
  ("start_phase_4",mnf_disable_all_keys,
    ...
    [
      ...
      [         
        ...
        (party_get_slot, ":original_faction", "$g_starting_town", slot_center_original_faction),
        (try_begin),
