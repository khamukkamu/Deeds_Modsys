...
["tourney_helm_white", "Tourney Helm White", [("o_hood_narf_base",0)], itp_type_head_armor|itp_attach_armature|itp_covers_head,0, 760 , weight(2.75)|abundance(100)|head_armor(30)|body_armor(0)|leg_armor(0), imodbits_plate,[(ti_on_init_item,[(cur_item_add_mesh, "@h_bascinet_fi", 0, 0),(cur_item_set_material, "@h_hood_narf_white", 0, 0),])]],
["tourney_helm_red", "Tourney Helm Red", [("o_hood_narf_base",0)], itp_type_head_armor|itp_attach_armature|itp_covers_head,0, 760 , weight(2.75)|abundance(100)|head_armor(30)|body_armor(0)|leg_armor(0), imodbits_plate ,[(ti_on_init_item,[(cur_item_add_mesh, "@h_bascinet_fi", 0, 0),(cur_item_set_material, "@h_hood_narf_red", 0, 0),])]],
["tourney_helm_blue", "Tourney Helm Blue", [("o_hood_narf_base",0)], itp_type_head_armor|itp_attach_armature|itp_covers_head,0, 760 , weight(2.75)|abundance(100)|head_armor(30)|body_armor(0)|leg_armor(0), imodbits_plate ,[(ti_on_init_item,[(cur_item_add_mesh, "@h_bascinet_fi", 0, 0),(cur_item_set_material, "@h_hood_narf_blue", 0, 0),])]],
["tourney_helm_green", "Tourney Helm Green", [("o_hood_narf_base",0)], itp_type_head_armor|itp_attach_armature|itp_covers_head,0, 760 , weight(2.75)|abundance(100)|head_armor(30)|body_armor(0)|leg_armor(0), imodbits_plate ,[(ti_on_init_item,[(cur_item_add_mesh, "@h_bascinet_fi", 0, 0),(cur_item_set_material, "@h_hood_narf_green", 0, 0),])]],
["tourney_helm_yellow", "Tourney Helm Yellow", [("o_hood_narf_base",0)], itp_type_head_armor|itp_attach_armature|itp_covers_head,0, 760 , weight(2.75)|abundance(100)|head_armor(30)|body_armor(0)|leg_armor(0), imodbits_plate ,[(ti_on_init_item,[(cur_item_add_mesh, "@h_bascinet_fi", 0, 0),(cur_item_set_material, "@h_hood_narf_brown", 0, 0),])]],
