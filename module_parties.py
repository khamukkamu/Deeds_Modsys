...
#  Other Locations
  ("zendar","Zendar",icon_castle_a|pf_location, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(64,9.3),[],300),
  ("salt_mine","Salt Mine",icon_bandit_lair|pf_location, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(155, -30),[],60),
  ("four_ways_inn","Four Ways Inn",icon_castle_c|pf_location, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(15.6, 26.3),[],300),
  ("dhorak_keep","Dhorak Keep",icon_castle_b|pf_location, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-35,-52.5),[],0),

  
#  Training Grounds (enabling the last one allows you to replay the tutorial from the world map)
  ("training_ground_1", "Training Field",  icon_training_ground|pf_location, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(37.4, 102.8),[], 100),
  ("training_ground_2", "Training Field",  icon_training_ground|pf_location, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-12.8, 33),[], 100),
  ("training_ground_3", "Training Field",  icon_training_ground|pf_location, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(70.5, 72.0),[], 100),
  ("training_ground_4", "Training Field",  icon_training_ground|pf_location, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(11.5, -75.2),[], 100),
  ("training_ground_5", "Training Field",  icon_training_ground|pf_location, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-125.8, 12.5),[], 100),
  ("tutorial_ground","Training Ground",icon_training_ground|pf_disabled|pf_location, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(3, -7),[]),
  
#  Ports
  ("port_1","_",icon_bridge_b|pf_village, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-16.9, 83.8),[], -30),
  ("port_2","_",icon_bridge_b|pf_village, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-54.1, 80.1),[], -20),
  ("port_5","_",icon_bridge_b|pf_village, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-95.5, -79.5),[], 80),
  ("port_6","_",icon_bridge_b|pf_village, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-96.7, 29.0),[], 15),
  ("port_12","_",icon_bridge_b|pf_village, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-0.4, 106.4),[], 10),
  ("port_13","_",icon_bridge_b|pf_village, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(65.5, 118.2),[], -10),
  ("port_15","_",icon_bridge_b|pf_village, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-133.7, -53.0),[], 90),
  ("port_19","_",icon_bridge_b|pf_village, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(7.7, -107.8),[], 105),
  ("landed_ship","Landed Ship",icon_ship_on_land|pf_village|pf_disabled, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(0, 0),[], 0),
  
#  Bridges
  ("bridge_1","{!}1",icon_bridge_snow_a|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(39.37, 65.10),[], -44.8),
  ("bridge_2","{!}2",icon_bridge_snow_a|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(56.44, 77.88),[], 4.28),
  ("bridge_3","{!}3",icon_bridge_snow_a|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(70.87, 87.95),[], 64.5),
  ("bridge_4","{!}4",icon_bridge_snow_a|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(93.71, 62.13),[], -2.13),
  ("bridge_5","{!}5",icon_bridge_snow_a|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(11.02, 72.61),[], 21.5),
  ("bridge_6","{!}6",     icon_bridge_b|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-8.83, 52.24),[], -73.5),
  ("bridge_7","{!}7",     icon_bridge_b|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-29.79, 76.84),[], -64),
  ("bridge_8","{!}8",     icon_bridge_b|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-64.05, -6),[], 1.72),
  ("bridge_9","{!}9",     icon_bridge_b|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-64.95, -9.60),[], -33.76),
  ("bridge_10","{!}10",   icon_bridge_b|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-75.32, -75.27),[], -44.07),
  ("bridge_11","{!}11",   icon_bridge_a|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-24.39, 67.82),[], 81.3),
  ("bridge_12","{!}12",   icon_bridge_a|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-114.33, -1.94),[], -35.5),
  ("bridge_13","{!}13",   icon_bridge_a|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-84.02, -7),[], -17.7),
  ("bridge_14","{!}14",   icon_bridge_a|pf_landmark, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-23.36, 75.8),[], 66.6),
...
# The reserved slots may be useful for maintaining savegame compatibility, since dynamic parties get IDs starting at the end of this file
  ("reserved_1"                  ,"{!}reserved",    pf_disabled|pf_is_static, no_menu, pt_none, fac_commoners,0,ai_bhvr_hold,0,(0., 0),[(trp_looter,15,0)]),
  ("reserved_2"                  ,"{!}reserved",    pf_disabled|pf_is_static, no_menu, pt_none, fac_commoners,0,ai_bhvr_hold,0,(0., 0),[(trp_looter,15,0)]),
  ("reserved_3"                  ,"{!}reserved",    pf_disabled|pf_is_static, no_menu, pt_none, fac_commoners,0,ai_bhvr_hold,0,(0., 0),[(trp_looter,15,0)]),
  ("reserved_4"                  ,"{!}reserved",    pf_disabled|pf_is_static, no_menu, pt_none, fac_commoners,0,ai_bhvr_hold,0,(0., 0),[(trp_looter,15,0)]),
  ("reserved_5"                  ,"{!}reserved",    pf_disabled|pf_is_static, no_menu, pt_none, fac_commoners,0,ai_bhvr_hold,0,(0., 0),[(trp_looter,15,0)]),
