...
#  ("killed_by_vaegir", "killed_by_vaegir.ogg", mtf_persist_until_finished|mtf_culture_2|mtf_sit_killed, 0),
  ...
  ("lords_hall_khergit", "lords_hall_khergit.ogg", mtf_culture_3, mtf_sit_town|mtf_sit_tavern|mtf_culture_all),
  ("lords_hall_nord", "lords_hall_nord.ogg", mtf_sit_town, mtf_sit_tavern),
  ("lords_hall_swadian", "lords_hall_swadian.ogg", mtf_sit_town, mtf_sit_tavern),
  ("lords_hall_rhodok", "lords_hall_rhodok.ogg", mtf_sit_town, mtf_sit_tavern),
  ("lords_hall_vaegir", "lords_hall_vaegir.ogg", mtf_sit_town, mtf_sit_tavern),
  ...
  ("town_neutral", "town_neutral.ogg", mtf_sit_town, mtf_sit_tavern),
  ("town_khergit", "town_khergit.ogg", mtf_culture_3|mtf_sit_town, mtf_sit_tavern|mtf_culture_all),
  ("town_nord", "town_nord.ogg", mtf_culture_4|mtf_sit_town, mtf_sit_tavern|mtf_culture_all),
  ("town_rhodok", "town_rhodok.ogg", mtf_culture_5|mtf_sit_town, mtf_sit_tavern|mtf_culture_all),
  ("town_swadian", "town_swadian.ogg", mtf_culture_1|mtf_sit_town, mtf_sit_tavern|mtf_culture_all),
  ("town_vaegir", "town_vaegir.ogg", mtf_culture_2|mtf_sit_town, mtf_sit_tavern|mtf_culture_all),

  ("uncertain_homestead", "uncertain_homestead.ogg", mtf_sit_town, mtf_sit_tavern),
  ("hearth_and_brotherhood", "hearth_and_brotherhood.ogg", mtf_sit_town, mtf_sit_tavern),
  ("tragic_village", "tragic_village.ogg", mtf_sit_town, mtf_sit_tavern),
