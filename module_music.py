...
# Ambush = Epic (num combatants >= 150)
  ...
  ("DAC-Battle-Epic-1",  "Battle/DAC-Battle-Epic-1.ogg",  mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
  ("DAC-Battle-Epic-2",  "Battle/DAC-Battle-Epic-2.ogg",  mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
  ("DAC-Battle-Epic-3",  "Battle/DAC-Battle-Epic-3.ogg",  mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
...
#  ("DAC-Battle-Epic-5",  "Battle/DAC-Battle-Epic-5.ogg",  mtf_module_track|mtf_sit_ambushed, mtf_culture_all), #ijustwant2bpure i suggest dropping this one, something weird happened to the audio quality and it is kind of short but also not very loopable.
  ...
  ("DAC-Battle-Epic-7",  "Battle/DAC-Battle-Epic-7.ogg",  mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
  ("DAC-Battle-Epic-8",  "Battle/DAC-Battle-Epic-8.ogg",  mtf_module_track|mtf_sit_ambushed, mtf_culture_all),
  ("DAC-Battle-Epic-9",  "Battle/DAC-Battle-Epic-9.ogg",  mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
  ("DAC-Battle-Epic-10", "Battle/DAC-Battle-Epic-10.ogg", mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
  ("DAC-Battle-Epic-11", "Battle/DAC-Battle-Epic-11.ogg", mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
  ("DAC-Battle-Epic-12", "Battle/DAC-Battle-Epic-12.ogg", mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
...
#  ("DAC-Battle-Epic-17", "Battle/DAC-Battle-Epic-17.ogg", mtf_module_track|mtf_sit_ambushed, mtf_culture_all), #ijustwant2bpure - i think this one is too short and not very loopable
  ("DAC-Battle-Epic-18", "Battle/DAC-Battle-Epic-18.ogg", mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
  ("DAC-Battle-Epic-19", "Battle/DAC-Battle-Epic-19.ogg", mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
  ...
  ("DAC-Battle-Epic-24", "Battle/DAC-Battle-Epic-24.ogg", mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
  ("DAC-Battle-Epic-25", "Battle/DAC-Battle-Epic-25.ogg", mtf_module_track|mtf_sit_ambushed, mtf_sit_fight),
