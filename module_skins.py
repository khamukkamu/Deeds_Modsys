...
(20, 0, -0.7, 0.7, "jaw_width"),
(30, 0, -0.6, 0.6, "mouth_width"),
(40, 0, -0.7, 0.7, "jaw_height"),
(50, 0, -0.5, 0.5, "cheeks"),
(60, 0, -0.5, 0.5, "nose_height"),
(70, 0, -0.5, 0.5, "nose_width"),
(80, 0, -1, 1, "nose_size"),
(90, 0, -1, 1, "nose_bridge"),
(100, 0, -0.9, 0.9, "_cheekbones"),
(110, 0, -0.5, 0.5, "eye_distance"),
(120, 0, -0.5, 0.5, "eye_shape"),
(130, 0, -0.8, 0.8, "eye_depth"),
(140, 0, -0.6, 0.6, "eyelids"),
(150, 0, -1, 0.6, "eye_size"),
(160, 0, -1, 1, "eyebrow_position"),
(170, 0, -1, 1, "eyebrow_height"),
(180, 0, -1, 1, "eyebrow_shape"),
(190, 0, -0.2, 0.2, "head_width"),
(200, 0, -0.8, 0.8, "face_depth"),
(210, 0, -0.5, 0.5, "face_ratio"),
(220, 0, -1, 1, "chin_width"),
(230, 0, -0.8, 1.2, "chin_height"),
(240, 0, -1, 1, "nose_shape"),
(250, 0, -1, 1, "eyebrow_depth"),
(260, 0, -0.8, 0.8, "temple_width"),
(270, 0, -0.5, 0.5, "mouth_to_nose_distance"),
(280, 0, -1, 1, "chin_size"),
(290, 0, -1, 1, "nose_tip"),
(300, 0, -0.7, 0.7, "nostril_size"),
(310, 0, -1, 1, "nose_arch"),
(320, 0, -1, 1, "chin_cleft"),
(330, 0, -1, 1, "jaw_definition"),
(340, 0, -1, 1, "upper_lip"),
(350, 0, -1, 1, "lower_lip"),
(360, 0, -1, 1, "upper_lip_heart"),
(370, 0, -1, 1, "lower_lip_shape"),
# (380, 0, -1, 1, "smile"),
# (390, 0, -1, 1, "frown"),
# (400, 0, -1, 1, "eye_iris_size"),
# (410, 0, -1, 1, "pointy_ear"),
...
skins = [
  (
    ...
    ["man_hair_s","man_hair_m","man_hair_n","man_hair_o", "man_hair_y10", "man_hair_y12","man_hair_p","man_hair_r","man_hair_q","man_hair_y7","man_hair_y9","man_hair_y11","man_hair_y8","man_hair_u","man_hair_y","man_hair_y2","man_hair_y4"], #man_hair_meshes ,,
    ["beard_e","beard_d","beard_k","beard_l","beard_i","beard_j","beard_z","beard_m","beard_n","beard_y","beard_p",   "beard_v", "beard_f", "beard_b", "beard_c","beard_t","beard_u","beard_r","beard_s","beard_a","beard_h","beard_g",], #beard meshes ,"beard_q"
    ...
    [
     ...
     ("manface_3",0xffd0e0e0,["hair_blonde"],[0xff2f180e, 0xff171313, 0xff007080c]),     
     ("manface_4",0xffd0d0d0,["hair_blonde"],[0xffffffff, 0xffb04717, 0xff632e18, 0xff502a19, 0xff19100c]),
    ...
    ("manface_11",0xffd5d5c5,["hair_blonde"],[0xffffffff, 0xffb04717, 0xff632e18, 0xff502a19, 0xff19100c]),
    ("manface_12",0xffd5d5c5,["hair_blonde"],[0xffffffff, 0xffb04717, 0xff632e18, 0xff502a19, 0xff19100c]),	
    ("manface_13",0xffd5d5c5,["hair_blonde"],[0xffffffff, 0xffb04717, 0xff632e18, 0xff502a19, 0xff19100c]),	
     ], #man_face_textures,
