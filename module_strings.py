...
from dac_character_creation import character_creation_strings
...
("a_breastplate_over_gambeson_blue",    "{!}a_breastplate_over_gambeson_blue"),
("a_breastplate_over_gambeson_black",   "{!}a_breastplate_over_gambeson_black"),
("a_breastplate_over_gambeson_green",   "{!}a_breastplate_over_gambeson_green"),
("a_breastplate_over_gambeson_red",     "{!}a_breastplate_over_gambeson_red"),
("a_breastplate_over_gambeson_white",   "{!}a_breastplate_over_gambeson_white"),
("a_breastplate_over_gambeson_end",     "{!}a_breastplate_over_gambeson_end"),
...
## Lance With Pennon
# French 
("w_triangular_pennon_small_b_blue",    "{!}w_triangular_pennon_small_b_blue"),
("w_triangular_pennon_small_b_white",   "{!}w_triangular_pennon_small_b_white"),
# English
("w_triangular_pennon_small_b_red",     "{!}w_triangular_pennon_small_b_red"),
# Burgundian
("w_triangular_pennon_small_b_brown",   "{!}w_triangular_pennon_small_b_brown"),
("w_triangular_pennon_small_b_white_2", "{!}w_triangular_pennon_small_b_white"),
# Breton
("w_triangular_pennon_small_b_black",   "{!}w_triangular_pennon_small_b_black"),  
("w_triangular_pennon_small_b_end",     "{!}w_triangular_pennon_small_b_end"),

## Lance With Pennon
# French 
("w_triangular_pennon_small_f_blue",    "{!}w_triangular_pennon_small_f_blue"),
("w_triangular_pennon_small_f_white",   "{!}w_triangular_pennon_small_f_white"),
# English                   
("w_triangular_pennon_small_f_red",     "{!}w_triangular_pennon_small_f_red"),
# Burgundian                
("w_triangular_pennon_small_f_brown",   "{!}w_triangular_pennon_small_f_brown"),
("w_triangular_pennon_small_f_white_2", "{!}w_triangular_pennon_small_f_white"),
# Breton                    
("w_triangular_pennon_small_f_black",   "{!}w_triangular_pennon_small_f_black"),  
("w_triangular_pennon_small_f_end",     "{!}w_triangular_pennon_small_f_end"),

## Lance With Pennon
# French 
("w_triangular_pennon_small_l_blue",    "{!}w_triangular_pennon_small_l_blue"),
("w_triangular_pennon_small_l_white",   "{!}w_triangular_pennon_small_l_white"),
# English                   
("w_triangular_pennon_small_l_red",     "{!}w_triangular_pennon_small_l_red"),
# Burgundian                
("w_triangular_pennon_small_l_brown",   "{!}w_triangular_pennon_small_l_brown"),
("w_triangular_pennon_small_l_white_2", "{!}w_triangular_pennon_small_l_white"),
# Breton                    
("w_triangular_pennon_small_l_black",   "{!}w_triangular_pennon_small_l_black"),  
("w_triangular_pennon_small_l_end",     "{!}w_triangular_pennon_small_l_end"),
...
("dac_garrison_force_local",        "Free but it will lower prosperity, your honor and negatively impact relations."),
("dac_garrison_hire_mercenaries",   "Fewer troops than hiring localy. No bonuses or downsides otherwise. ^Lower price based on trade and/or mercenary background"),

#utility for skill names
]+[
("skl_"+skills[x][0], skills[x][1]) for x in range(0, len(skills))]

strings = strings + character_creation_strings