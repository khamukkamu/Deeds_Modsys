...
#backstory intro
  ...
  ("npc10_backstory_a", "I'm Fr̬re Hardouin du Puy and I am currently looking for employment."),
  ...
  ("npc16_backstory_a", "I'm Fr̬re Martin d'Autun and I am currently looking for employment."),
...
#11
  ...
  ("npc3_payment", "{!}."),
  ("npc4_payment", "Could I get {reg3} crows as advance payment?"),
  ("npc5_payment", "Could I get {reg3} crows as advance payment?"),
  ("npc6_payment", "{!}."),
  ("npc7_payment", "Could I get {reg3} crows as advance payment?"),
  ("npc8_payment", "Could I get {reg3} crows as advance payment?"),
  ("npc9_payment", "Could I get {reg3} crows as advance payment?"),
  ("npc10_payment", "Could I get {reg3} crows as advance payment?"),
  ("npc11_payment", "Could I get {reg3} crows as advance payment?"),
  ("npc12_payment", "{!}."),
  ("npc13_payment", "Could I get {reg3} crows as advance payment?"),
  ("npc14_payment", "Could I get {reg3} crows as advance payment?"),
  ("npc15_payment", "Could I get {reg3} crows as advance payment?"),
  ("npc16_payment", "Could I get {reg3} crows as advance payment?"),
...
#steve post 0912 changes begin
  ...
  ("nord_rebellion_pretender_intro",       "I am Olivier de Blois, comte de Penthi̬vre, who should be leading Brittany against its enemies."),
