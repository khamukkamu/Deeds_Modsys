...
##################################################################################################################################################################################################################################################################################################################
  ...
  ("raider_party","Raiders",icon_gray_knight|carries_goods(8)|pf_show_faction,0,fac_commoners,bandit_personality,[]),
  ("raider_captives","Raider Captives",0,0,fac_commoners,0,[(trp_peasant_woman,2,15,pmf_is_prisoner),(trp_farmer,2,10,pmf_is_prisoner)]),
  ...
  ("prisoner_train_party","Prisoner Train",icon_mule|carries_goods(5)|pf_show_faction,0,fac_commoners,merchant_personality,[]),
  ("default_prisoners","Default Prisoners",icon_vaegir_knight,0,fac_commoners,0,[(trp_irrate_hunter,3,8,pmf_is_prisoner),(trp_disgruntled_farmer,3,8,pmf_is_prisoner),(trp_furious_lumberjack,3,8,pmf_is_prisoner)]),
...
("kingdom_1_reinforcements_a", "kingdom_1_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_french_peasant_levy,1,5),(trp_french_poor_spearman,1,3),(trp_french_spearman,1,3),(trp_french_vougier,1,4),(trp_french_poor_archer,1,6)]),
("kingdom_1_reinforcements_b", "kingdom_1_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_french_crossbowman,1,3),(trp_french_pavoisier,2,7),(trp_french_guisarmier,1,4),(trp_french_militia,1,3),(trp_french_vougier,1,3),(trp_french_spearman,1,2)] ),
("kingdom_1_reinforcements_c", "kingdom_1_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_genoese_crossbowman,1,2),(trp_french_rich_crossbowman,1,3),(trp_french_pavoisier,2,5),(trp_french_rich_guisarmier,1,3),(trp_french_rich_pavoisier,1,2),(trp_french_sergeant,1,1)] ),
("kingdom_1_reinforcements_d", "kingdom_1_reinforcements_d", 0, 0, fac_commoners, 0, [(trp_french_spearman_at_atms,1,4),(trp_french_man_at_arms,2,6),(trp_french_dismounted_squire,1,4),(trp_french_squire,2,6),(trp_french_chevalier_a_pied,1,3),(trp_french_chevalier,1,3),] ),
...
("kingdom_2_reinforcements_a", "kingdom_2_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_english_communal_levy,1,5),(trp_english_communal_levy_footman,1,3),(trp_english_communal_footman,1,3),(trp_english_communal_vougier,1,4),(trp_english_communal_bowman,1,6)]),
("kingdom_2_reinforcements_b", "kingdom_2_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_english_garrison_crossbowman,1,3),(trp_english_archer,2,7),(trp_english_footman,1,4),(trp_english_militia,1,3),(trp_english_heavy_footman,1,3),(trp_english_communal_footman,1,2)] ),
("kingdom_2_reinforcements_c", "kingdom_2_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_english_yeoman_archer,1,2),(trp_english_archer,1,3),(trp_english_footman,2,5),(trp_english_heavy_footman,1,3),(trp_english_retinue_archer,1,2),(trp_english_sergeant,1,1)] ),
("kingdom_2_reinforcements_d", "kingdom_2_reinforcements_d", 0, 0, fac_commoners, 0, [(trp_english_footman_at_arms,1,4),(trp_english_man_at_arms,2,6),(trp_english_dismounted_squire,1,4),(trp_english_squire,2,6),(trp_english_dismounted_knight,1,3),] ),
...
("kingdom_3_reinforcements_a", "kingdom_3_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_burgundian_peasant,1,5),(trp_burgundian_poor_spearman,1,5),(trp_burgundian_poor_vougier,1,4),(trp_burgundian_peasant_bowman,1,3),(trp_burgundian_poor_bowman,1,3)]),
("kingdom_3_reinforcements_b", "kingdom_3_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_burgundian_militia_archer,1,3),(trp_burgundian_militia,1,6),(trp_burgundian_poor_guisarmier,1,4),(trp_burgundian_pavoisier,1,3),(trp_burgundian_poor_archer,1,3),(trp_burgundian_poor_crossbowman,1,2)] ),
("kingdom_3_reinforcements_c", "kingdom_3_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_burgundian_rich_pavoisier,1,2),(trp_burgundian_archer,1,3),(trp_burgundian_crossbowman,1,4),(trp_burgundian_rich_guisarmier,1,4),(trp_burgundian_sergeant_pavoisier,1,1)] ),
("kingdom_3_reinforcements_d", "kingdom_3_reinforcements_d", 0, 0, fac_commoners, 0, [(trp_burgundian_footman_at_arms,1,4),(trp_burgundian_man_at_arms,2,6),(trp_burgundian_dismounted_squire,1,3),(trp_burgundian_squire,1,3),(trp_burgundian_knight,1,3)] ),
("kingdom_3_reinforcements_e", "kingdom_3_reinforcements_e", 0, 0, fac_commoners, 0, [(trp_burgundian_bannerman,1,1),(trp_burgundian_bannerman_mounted,1,1),] ),

("kingdom_4_reinforcements_a", "kingdom_4_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_breton_peasant_levy,1,5),(trp_breton_spearman,1,5),(trp_breton_vougier,1,4),(trp_breton_peasant_archer,1,6)]),
("kingdom_4_reinforcements_b", "kingdom_4_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_breton_militia_crossbowman,1,3),(trp_breton_pavoisier,2,7),(trp_breton_guisarmier,1,4),(trp_breton_rich_pavoisier,1,3),(trp_breton_militia,1,3),(trp_breton_militia_crossbowman,1,2)] ),
("kingdom_4_reinforcements_c", "kingdom_4_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_breton_archer,1,3),(trp_breton_crossbowman,1,2),(trp_breton_guisarmier,2,6),(trp_breton_rich_guisarmier,1,4),(trp_breton_rich_pavoisier,1,4),(trp_breton_sergeant,1,1)] ),
("kingdom_4_reinforcements_d", "kingdom_4_reinforcements_d", 0, 0, fac_commoners, 0, [(trp_breton_footman_at_arms,1,4),(trp_breton_squire,2,6),(trp_breton_chevalier,1,3),(trp_breton_dismounted_squire,1,3),(trp_breton_chevalier_a_pied,1,3),] ),
("kingdom_4_reinforcements_e", "kingdom_4_reinforcements_e", 0, 0, fac_commoners, 0, [(trp_breton_bannerman,1,1),(trp_breton_bannerman_mounted,1,1),] ),
