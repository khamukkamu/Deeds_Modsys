...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_single", 0, amf_client_prediction,
   # [5.0, "sa_stand_single_closed", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ...
 ["stand_staff", 0, amf_client_prediction,
   ...
   [3.0, "sa_staff_cstance", 0, 120, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
...
##   [0.8, "run_greatsword", 0, 22, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
   ...
   # [1.0, "walk_staff_3", 0, 32, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
...
# duration and controlled via weapon speed.
 ["ready_bow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_bow,
   [1.8, "rg_bow_anim", 16, 133, blend_in_ready|arf_make_custom_sound, pack2f(0.14, 0.44)],
 ],
 ["release_bow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_bow,
   [.4, "rg_bow_anim", 133, 174, arf_blend_in_2],
 ],
 #not used
 ...
 ["reload_crossbow", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [2.2, "crossbow_reload_pavise", 0, 120, arf_blend_in_8|arf_make_custom_sound, pack2f(0.40, 0.94)], 
 ...
 ["reload_crossbow_horseback", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [2.3, "anim_human", combat+1800, combat+1877, arf_blend_in_8|arf_make_custom_sound, pack2f(0.27, 0.94)], 
 ],
...
##   [ready_durn, "slashright_twohanded", 10, 16, blend_in_ready], 
   # [ready_durn, "slashright_twohanded", 10, 18, blend_in_ready], ### Native
   [ready_durn, "pl_twohanded_slashright", 0, 5, blend_in_ready], 
 ],
...
##   [0.62, "slashright_twohanded", 16, 40, blend_in_release], 
   # [0.61, "slashright_twohanded", 18, 38, blend_in_release], ### Native
   [0.61, "pl_twohanded_slashright", 5, 28, blend_in_release], 
 ],
...
##   [0.3, "slashright_twohanded", 45, 61, blend_in_continue], 
   # [0.5, "slashright_twohanded", 38, 61, blend_in_continue], ### Native
   [0.5, "pl_twohanded_slashright", 28, 49, blend_in_continue], 
 ],
 ...
 ["ready_slashleft_twohanded", acf_right_cut|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
   # [ready_durn, "slashleft_twohanded", 12, 16, blend_in_ready], ### Native
   [ready_durn, "pl_twohanded_slashleft", 0, 5, blend_in_ready], 
 ],
 ["release_slashleft_twohanded", acf_right_cut|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
   # [0.61, "slashleft_twohanded", 16, 38, blend_in_release], ### Native
   [0.61, "pl_twohanded_slashleft", 5, 32, blend_in_release], 
 ],
 ["release_slashleft_twohanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   # [0.5, "slashleft_twohanded", 38, 52, blend_in_continue], ### Native
   [0.5, "pl_twohanded_slashleft", 32, 49, blend_in_continue], 
 ],
...
##   [ready_durn, "attacks_single_righttoleft", 5, 10, blend_in_ready], 
   # [ready_durn, "attacks_single_righttoleft", 2, 5, blend_in_ready], ### Native
   [ready_durn, "pl_onehanded_slashright", 0, 5, blend_in_ready], 
 ],
...
##   [0.6, "attacks_single_righttoleft", 10, 26, blend_in_release], 
   # [0.6, "attacks_single_righttoleft", 5, 28, blend_in_release], ### Native
   [0.6, "pl_onehanded_slashright", 5, 30, blend_in_release], 
 ],
...
##   [0.4, "attacks_single_righttoleft", 26, 43, blend_in_continue], 
   # [0.4, "attacks_single_righttoleft", 28, 44, blend_in_continue], ### Native
   [0.4, "pl_onehanded_slashright", 30, 35, blend_in_continue], 
 ],
...
##   [ready_durn, "attacks_single_lefttoright", 12, 21, blend_in_ready], 
   # [ready_durn, "attacks_single_lefttoright", 4, 11, blend_in_ready], ### Native
   [ready_durn, "pl_onehanded_slashleft", 0, 5, blend_in_ready], 
 ],
...
##   [0.61, "attacks_single_lefttoright", 21, 40, blend_in_release], 
   # [0.61, "attacks_single_lefttoright", 11, 29, blend_in_release], ### Native
   [0.61, "pl_onehanded_slashleft", 5, 29, blend_in_release], 
 ],
...
##   [0.4, "attacks_single_lefttoright", 40, 50, blend_in_continue],
   # [0.4, "attacks_single_lefttoright", 29, 43, blend_in_continue], ### Native
   [0.4, "pl_onehanded_slashleft", 29, 34, blend_in_continue], 
 ],
...
["crouch_unarmed", 0, amf_client_prediction, # Fix by Dunde
 ...
 ["reload_pistol_half", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   ...
   [1.2, "anim_human", 125, 250, arf_blend_in_3],
 ],
 ...
 ["ready_thrust_musket", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  ...
  [ready_durn, "anim_human", 1, 19, blend_in_ready],
 ],
 ...
 [0.9, "anim_human", 19, 50, blend_in_release],
 ],
 ["release_thrust_musket_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  ...
  [0.2, "anim_human", 50, 54, arf_blend_in_2],
 ],
 ["parried_thrust_musket", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
   ...
   [attack_parried_duration, "anim_human", 1, 9, arf_blend_in_2],
 ],
 ["blocked_thrust_musket", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  ...
  [attack_blocked_duration, "anim_human", 1, 9, arf_blend_in_2],
 ],
...
# Commented out for TLD Prisoners
...
##   [2.5, "anim_horse", 505, 580,  arf_blend_in_8],
 ...
 ["horse_fall_roll", acf_enforce_all|acf_align_with_ground, amf_priority_striked|amf_keep|amf_client_prediction,
  ...
  # TLD - For Cheer - To cancel ani...(kham)
 ...
 #["unused_horse_anim_1", 0, 0, [1.0, "anim_horse", 0, 1, 0]], #Commented out for TLD Cheer
