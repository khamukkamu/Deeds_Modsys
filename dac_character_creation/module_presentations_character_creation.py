...
### Class Options
        ...
        (else_try),
            ...
            (overlay_add_item, "$g_presentation_obj_2", "str_dac_background_class_scout"),
            (overlay_add_item, "$g_presentation_obj_2", "str_dac_background_class_quartermaster"),
            (overlay_add_item, "$g_presentation_obj_2", "str_dac_background_class_cook"),
            (overlay_add_item, "$g_presentation_obj_2", "str_dac_background_class_sergeant"),
        (else_try),
        ...
        (else_try),
            ...
            (overlay_add_item, "$g_presentation_obj_2", "str_dac_background_class_scottish"),
        (else_try),
...
### Soldier Background 
        (else_try),
            (eq, "$g_presentation_obj_1_val", 2),
            (store_add, "$class_type", "$g_presentation_obj_2_val", cc_soldier_scout),
            (assign, ":mesh", "mesh_pic_siege_attack"),
            (assign, ":string_background", "str_dac_background_desc_soldier"),
            (assign, ":animation", "anim_pose_2"),
            (store_add, ":string_class", "$g_presentation_obj_2_val", "str_dac_background_class_desc_scout"),
            # Size
