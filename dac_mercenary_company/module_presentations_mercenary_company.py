...
### Troop Mesh   
    ...
    (else_try),
        (neq, ":object_id", "$g_presentation_obj_1"), ### Target
...
### Cancel Commission 1
        ...
        (try_begin),
            (troop_slot_eq, "trp_merc_company_smith", slot_camp_smith_creating_item, -1),
            (overlay_set_display, "$g_presentation_credits_obj_1", 0),
        (else_try),
...
### Cancel Commission text
        (try_begin),
            (eq, "$g_presentation_credits_obj_4", 1),
            (troop_get_slot, ":item", "trp_merc_company_smith", slot_camp_smith_creating_item),
            (call_script, "script_dac_print_item_commission_targets_to_s2", 1, ":item"),
        (else_try),
            (eq, "$g_presentation_credits_obj_4", 2),
            (troop_get_slot, ":item", "trp_merc_company_smith", slot_camp_smith_creating_item_2),
            (call_script, "script_dac_print_item_commission_targets_to_s2", 2, ":item"),        
        (else_try),
            (eq, "$g_presentation_credits_obj_4", 3),
            (troop_get_slot, ":item", "trp_merc_company_smith", slot_camp_smith_creating_item_3),
        ...
        (try_begin),
            ...
            (assign, reg10, ":value"),        
            (str_store_string, s4, "@Cancelling the production of {s3} for {s2} will refund only a portion of the cost which amounts to {reg10} crowns."),
        (else_try),
            (str_store_string, s4, "str_empty_string"),        
        (try_end),
        
        (create_text_overlay, "$g_presentation_credits_obj_5", s4, tf_left_align|tf_scrollable_style_2),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 560),
        ...
        (position_set_x, pos1, 300),
        (position_set_y, pos1, 120),
        (overlay_set_area_size, "$g_presentation_credits_obj_5", pos1),
        
        ### Cancel it
        (create_game_button_overlay, "$g_presentation_credits_obj_6", "@Cancel it", tf_center_justify),
        (position_set_x, pos1, 750),
        (position_set_y, pos1, 500),
...
### Return to Commissions
    ...
    (else_try),
        ...
        (assign, "$g_presentation_credits_obj_4", 2),
        (start_presentation, "prsnt_dac_manage_commissions"),
    (else_try),
        (eq, ":object_id", "$g_presentation_credits_obj_3"),
        (assign, "$g_presentation_credits_obj_4", 3),
        (start_presentation, "prsnt_dac_manage_commissions"),
    (else_try),
        (eq, ":object_id", "$g_presentation_credits_obj_6"),
        (try_begin),
            (eq, "$g_presentation_credits_obj_4", 1),
            (troop_get_slot, ":item", "trp_merc_company_smith", slot_camp_smith_creating_item),
            (item_get_value, ":value", ":item"),
            ...
            (display_message, "@Commission 1 cancelled!", color_neutral_news),
        (else_try),
            (eq, "$g_presentation_credits_obj_4", 2),
            (troop_get_slot, ":item", "trp_merc_company_smith", slot_camp_smith_creating_item_2),
            (item_get_value, ":value", ":item"),
            ...
            (display_message, "@Commission 2 cancelled!", color_neutral_news),           
        (else_try),
            (eq, "$g_presentation_credits_obj_4", 3),
            (troop_get_slot, ":item", "trp_merc_company_smith", slot_camp_smith_creating_item_3),
            (item_get_value, ":value", ":item"),
            ...
            (display_message, "@Commission 3 cancelled!", color_neutral_news),           
        (try_end),
        (assign, "$g_presentation_credits_obj_4", -1),
        (start_presentation, "prsnt_dac_manage_commissions"),
    (else_try),
