...
# Tier 3 #
  ...
  ["custom_merc_veteran_selection","{!}na","{!}na",tf_hero|tf_inactive,0,0,fac_neutral,
    ...
    itm_s_heraldic_shield_a1,
    itm_s_heraldic_shield_a2,
    itm_s_heraldic_shield_b1,
    itm_s_heraldic_shield_b2,
    itm_s_heraldic_shield_c1,
    itm_s_heraldic_shield_c2,
    itm_s_heraldic_shield_d1,
    itm_s_heraldic_shield_d2,
    itm_tab_shield_kite_c,
    itm_tab_shield_heater_c,
    ], def_attrib|level(1),wp(60),knows_common|knows_inventory_management_10,0],
...
##################################################################################################################################################################################################################################################################################################################
  ...
  ["custom_merc_foot_squire_selection","{!}na","{!}na",tf_hero|tf_inactive,0,0,fac_neutral,
    ...
    itm_s_kite_shield_a1,
    itm_s_kite_shield_a2,
    itm_s_kite_shield_b1,
    itm_s_kite_shield_b2,
    itm_s_kite_shield_d2,
    itm_s_kite_shield_c1,
    itm_s_kite_shield_c2,
    itm_s_kite_shield_d1,
    itm_s_kite_shield_d2,
    itm_tab_shield_heater_c,
    ], def_attrib|level(1),wp(60),knows_common|knows_inventory_management_10,0], 
  ...
  ["custom_merc_footman_at_arms_selection","{!}na","{!}na",tf_hero|tf_inactive,0,0,fac_neutral,
    ...
    itm_s_battle_shield_edward,
    itm_s_battle_shield_prince_1,
    itm_s_battle_shield_prince_2,
    itm_s_battle_shield_a1,
    itm_s_battle_shield_a2,
    itm_s_battle_shield_b1,
    itm_s_battle_shield_b2,
    itm_s_battle_shield_e1,
    itm_s_battle_shield_e2,
    itm_s_battle_shield_f1,
    itm_s_battle_shield_f2,
