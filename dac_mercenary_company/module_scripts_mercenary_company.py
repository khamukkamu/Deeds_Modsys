...
("initialize_item_tiers", [
    (try_for_range, ":item_no", all_items_begin, normal_items_end),
        ...
        (try_begin),
            ...
            (else_try),
                (is_between, ":crossbow_damage", 50, 54),
                (item_set_slot, ":item_no", slot_item_crossbow_tier, 2), 
            (else_try),
                (is_between, ":crossbow_damage", 54, 60),
        ...
        (try_begin),
            ...
            (try_begin),
                (is_between, ":shield_resistance", 0, 8),
                (item_set_slot, ":item_no", slot_item_shield_tier, 1),
            (else_try),
                (is_between, ":shield_resistance", 8, 12),
            ...
            (else_try),
                (item_set_slot, ":item_no", slot_item_shield_tier, 4),                 
            (try_end),
        (try_end),
