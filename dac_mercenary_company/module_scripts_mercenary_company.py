...
("initialize_item_tiers", [
    (try_for_range, ":item_no", all_items_begin, normal_items_end),
        ...
        (try_begin),
            ...
            (try_begin),
                (is_between, ":two_handed_sword_swing_damage", 0, 42),
                (item_set_slot, ":item_no", slot_item_two_handed_sword_tier, 1),
            (else_try),
                (is_between, ":two_handed_sword_swing_damage", 42, 44),
        ...
        (try_begin),
            ...
            (else_try),
                (item_set_slot, ":item_no", slot_item_arrow_tier, 4),                 
            (try_end),
        (try_end),
